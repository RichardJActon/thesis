...
On the Illumina methylation arrays control probes ([@Illumina2015] p226) are located at non-CpG cytosines to assay the conversion efficiency for use in quality control assesment of array data.
...
(ref:targetedBiSseqFluidigmGeneric-Cap) __Microfluidic system for multiple parallel pairwise PCR reactions.__
...
(ref:targetedBiSseqFluidigmPCR-Cap) __Four primer step-out PCR for targeted bisulfite sequencing on the Fluidigm access array.__ 
