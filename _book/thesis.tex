...
The activity of Maf1 is modulated by the Target of Rapamycin Kinase Complex 1 (TORC1) {[}\protect\hyperlink{ref-Mange2017}{263}{]}.
Several general transcription factors also influence tRNA gene expression; the tumour suppressors p53 {[}\protect\hyperlink{ref-Crighton2003}{264}{]} and Rb {[}\protect\hyperlink{ref-Sutcliffe2000}{265}{]} both negatively regulate tRNA expression and c-Myc upregulates tRNA gene expression, all act via TFIIIB {[}\protect\hyperlink{ref-Gomez-Roman2003}{266}{]}.
tRNAs are dysregulated in cancer, and have potential utility as prognostic markers {[}\protect\hyperlink{ref-Krishnan2016}{267}{]}.
tRNA regulation may play an important role in cancer {[}\protect\hyperlink{ref-Huang2018}{268}{]}.
DNAm is able to repress the expression of tRNA genes experimentally {[}\protect\hyperlink{ref-Besser1990}{269}{]}, in plasmid expression systems, but may also represent co-ordination with the local repressive chromatin state {[}\protect\hyperlink{ref-Varshney2015}{270}{]}.
Transcription is also repressed by the highly conserved polIII specific transcription factor Maf1 {[}\protect\hyperlink{ref-Murawski1994}{260},\protect\hyperlink{ref-Pluta2001}{261}{]}, who's activity is modulated by the Target of Rapamycin Kinase Complex 1 (TORC1) {[}\protect\hyperlink{ref-Mange2017}{263}{]}, a highly conserved hub for signals that modulate ageing {[}\protect\hyperlink{ref-Kennedy2016}{271}{]}.
...
DNAm is able to repress the expression of tRNA genes on methylated expression vectors {[}\protect\hyperlink{ref-Besser1990}{269}{]}.
...
Transcription by RNA polymerase III at SINE loci is suppressed by histone methylation but not by DNA methylation {[}\protect\hyperlink{ref-Varshney2015}{270}{]}, indicating that DNA methylation may not directly influence the expression of tRNA genes but may do so by influencing the surrounding chromatin state.
...
Thus variants on standard RNA-seq procedures have been developed {[}\protect\hyperlink{ref-Cozen2015}{287}--\protect\hyperlink{ref-Gogakos2017}{289}{]}. polIII ChIP-seq has been used as a proxy for tRNA gene expression, and unlike RNA-seq based methods generates reads from uniquely identifiable flanking regions which map to a known locus of origin.
...
In fission yeast, a subset of B-box sequence elements bound TFIIIC and not polIII serve as chromatin anchors to the nuclear periphery and act as boundaries between euchromatic and heterochromatic regions {[}\protect\hyperlink{ref-Noma2006}{292}{]}.
...
We excluded 107 tRNAs from blacklisted regions of hg19 {[}\protect\hyperlink{ref-Amemiya2019}{295}{]}.

\hypertarget{clustering}{%
\subsubsection{tRNA Gene Clustering}\label{clustering}}

We clustered the tRNA genes by grouping together all tRNAs within 5Mb of one another using the \texttt{bedtools\ merge} tool v2.17.0 {[}\protect\hyperlink{ref-Quinlan2010}{171}{]}.
We used a command of the form: \texttt{bedtools\ merge\ -c\ 4\ -o\ collapse\ -d\ \textless{}N\textgreater{}\ -i\ hg19-tRNAs.bed} where \texttt{\textless{}N\textgreater{}} is the binsize.
We varied the binsize and selected 5Mb as it is at approximately this size that number of clusters with more than one tRNAs exceeds the number of singleton tRNAs (Figure \ref{fig:heyn} a).
...
Initial QC for readcount, base call quality and base composition was caried out with \texttt{FastQC} (\url{https://github.com/s-andrews/FastQC}) {[}\protect\hyperlink{ref-Andrews2010}{169}{]} and \texttt{multiqc} (\url{https://github.com/ewels/MultiQC}) {[}\protect\hyperlink{ref-Ewels2016}{300}{]} for combined visualisation of QC outputs.
Quality based trimming was performed with \texttt{Trim\ Galore} (\url{https://github.com/FelixKrueger/TrimGalore}) {[}\protect\hyperlink{ref-Krueger2015}{301}{]} and target specific primer trimming with \texttt{cutadapt} (\url{https://github.com/marcelm/cutadapt}) {[}\protect\hyperlink{ref-Martin2011}{302}{]} and custom \texttt{perl\ 5} scripts.
...
These data were available for this analysis in a pre-processed form, Methylation `beta' values subject to beta-mixture quantile normaisation (BMIQ) as previously described {[}\protect\hyperlink{ref-Bell2017a}{67},\protect\hyperlink{ref-Bell2016}{151}{]}.
...
We used small RNA-seq data from sorted blood cell fractions {[}\protect\hyperlink{ref-Juzenas2017}{312}{]} (\href{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE100467}{GSE100467}) and the MINTmap {[}\protect\hyperlink{ref-Loher2017}{248}{]} tRNA fragment alignment tool.
...
We downloaded methylation calls and coverage information resulting from RRBS performed by Petkovich \emph{et al.} {[}\protect\hyperlink{ref-Petkovich2017}{313}{]} from GEO using \texttt{GEOquery} {[}\protect\hyperlink{ref-Davis2007p}{308}{]} \href{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE80672}{GSE80672}.
...
We excluded 5 tRNAs from blacklisted regions of mm10 {[}\protect\hyperlink{ref-Amemiya2019}{295}{]}.
After QC there were 58 tRNA genes and 385 CpGs.
We performed simple linear modelling in \texttt{R} to predict age (in months) from methylation level at each tRNA and each CpG.
...
We identified 21 genome-wide significant and 44 study-wide significant results (p \textless{} \(4.34\times10^{-9}\) and \(8.36\times10^{-5}\), respectively, via linear regression see \protect\hyperlink{medipmodels}{Methods} \ref{medipmodels} (batch corrected n=4350).
...
To assess whether this hypermethylation finding was being driven merely by the inherent CpG density of the tRNAome, we performed a CpG density matched permutation analysis (1,000X, see \protect\hyperlink{AgeErichmentPermutation}{Methods} \ref{AgeErichmentPermutation}).
...
We clustered the tRNA genes by grouping together all tRNAs within 5Mb of one another and then required that a cluster contain at least 5 tRNA genes with a density of at least 5 tRNA genes per Mb (see \protect\hyperlink{clustering}{Methods} \ref{clustering}).
...
We examined an available Whole Genome Bisulphite sequencing (WGBS) dataset from Heyn \emph{et al.} {[}\protect\hyperlink{ref-Heyn2012}{113}{]} (see \protect\hyperlink{tRNAmethods}{Methods} \ref{tRNAmethods})
...
We performed this targeted BiS-seq in blood-derived DNA from 8 pools of age-matched individuals at 4 time-points (\textasciitilde4, \textasciitilde28, \textasciitilde63, \textasciitilde78 years) from a total of 190 individuals, as detailed in Table \ref{fig:poolSummaryTable}.
...
This approach permitted us to assay tRNA gene DNA methylation across a large number of individuals whilst requiring a minimal amount of DNA from each individual (80-100ng), and costing \textasciitilde1/24th as much as performing sequencing individually.
...
\caption{(ref:DNAmAgeVsChronAgeCap)}\label{fig:DNAmAgeVsChronAge}
\end{figure}

(ref:DNAmAgeVsChronAgeCap)
Mean chronological age is tightly correlated with DNAm Horvath clock {[}\protect\hyperlink{ref-Horvath2013}{119}{]} predicted age for the 8 pooled samples. (See Table \ref{fig:poolSummaryTable} for pool details).
...
{\centering \includegraphics[width=0.8\linewidth]{./figs/combined_Nokaryo_sig_bl_iMet-EPIC} 
...
We further explored the activity of the tRNAome in public Chromatin segmentation data in blood (Epilogos Blood \& T-cells set) {[}\protect\hyperlink{ref-Meuleman2019}{306}{]}.
...
We used a publically available 450k array dataset {[}\protect\hyperlink{ref-Reinius2012}{307}{]}) that has been used in the construction of cell-type specific DNAm references for cell-type fraction prediction using the Houseman algorithm {[}\protect\hyperlink{ref-Houseman2012}{146}{]} (see \protect\hyperlink{sortedbloodmethods}{Methods} \ref{sortedbloodmethods}).
...
We used a mix of 450k and 27k array data from `solid tissue normal' samples made available by TCGA (The Cancer Genome Atlas) and data from foetal tissue {[}\protect\hyperlink{ref-Yang2016}{310},\protect\hyperlink{ref-Nazor2012}{311}{]} downloaded from GEO (see \protect\hyperlink{TCGAmethods}{Methods} \ref{TCGAmethods}).
...
We created customised MINTmap {[}\protect\hyperlink{ref-Loher2017}{248}{]} reference designed to include only fragments which unambiguously map to a single tRNA gene locus and which overlap the 5' or 3' end of the genomic tRNA sequence by at least one base with no mismatches.
...
We examined the DNA methylation of the mouse tRNA genes in using data from a reduced representation bisulfite sequencing (RRBS) experiment performed by Petkovich et al.~{[}\protect\hyperlink{ref-Petkovich2017}{313}{]}.
...
In order to investigate the mouse results further we made use of data from Thornlow et al.~{[}\protect\hyperlink{ref-Thornlow2020}{316}{]}, which had established tRNA ortholog sets for 29 mammalian species.
...
We took a coarse grained look at the tRNA DNA methylome in tumour samples with matched normal tissue data, considering the 45 tRNA genes and 19 tissues for which we have data.
Across multiple tissues we find that both tumour and `normal' samples have a strong preponderance for low levels of methylation consistent with the active transcription of many tRNA genes.
...
These differences are small in absolute terms and have very wide error margins but are consistent with a picture of dysregulation in cancer cells {[}\protect\hyperlink{ref-Huang2018}{268}{]}.
...
Whilst the changes in DNA methylation we have observed are relatively small (i.e.~3.7\% between 4-year to 78-year pools in tRNA-iMet-CAT-1-4), this is consistent with the effect size seen in the majority of positions differentially methylatyed with age in many other studies {[}\protect\hyperlink{ref-Slieker2016}{101},\protect\hyperlink{ref-Xu2014b}{318}{]}, except for the noted extreme outliers, such as \emph{EVOLV2} {[}\protect\hyperlink{ref-Slieker2018}{319}{]}.
Furthermore, effect size cut-offs have distinct limitations, they to not generalise well between studies and they have been observed to remove a large fraction of true age-DMPs {[}\protect\hyperlink{ref-Zhu2018}{320}{]}.

We subsequently explored further what was driving this age-related phenomenon and its possible biological implications.
As this result was observed in peripheral blood, we were well aware that we were examining DNA derived from a heterogeneous cell type population {[}\protect\hyperlink{ref-Lappalainen2017}{321}{]}.
...
Due to the high number of hypermethylating tRNAs prior to cell-type correction, we were also curious whether the epigenetic state of this small tRNAome fraction of genome could capture cell-type.
...
Isodecoders expand in number with organismal complexity and the high prevalence in mammals has been suggested due to their additional regulatory functionality {[}\protect\hyperlink{ref-Keam2014}{245},\protect\hyperlink{ref-Goodenbour2006}{322}{]}.
...
Codon usage frequencies have been claimed to be mostly invariant in the transcriptomes of a wide range of tissues, as well as across developmental time {[}\protect\hyperlink{ref-Schmitt2014b}{314}{]}, however differences in the codon usage of gene with highly tissue specifically expressed genes have been observed {[}\protect\hyperlink{ref-Plotkin2004}{325}{]}.
...
Several transcription factors acting via TFIIIB {[}\protect\hyperlink{ref-Gomez-Roman2003}{266}{]} have a negative (the tumour suppressors p53 {[}\protect\hyperlink{ref-Crighton2003}{264}{]} and Rb {[}\protect\hyperlink{ref-Sutcliffe2000}{265}{]}) or positive (the proto-oncogene c-Myc) influence {[}\protect\hyperlink{ref-Gomez-Roman2003}{266}{]}.
...
Whilst DNAm is able to repress the expression of tRNA genes {[}\protect\hyperlink{ref-Besser1990}{269}{]} in a plasmid expression system, the broader chromatin environment also affects tRNA transcription.
...
It is worth noting the parallels with known cancer and ageing epigenetic changes, and that tRNAs are also dysregulated in cancer {[}\protect\hyperlink{ref-Huang2018}{268}{]}, with proposed utility as prognostic markers {[}\protect\hyperlink{ref-Krishnan2016}{267}{]}.
...
We observed a predominantly unmethylated state across fetal (Figure \ref{fig:meanMethBytRNAByFetalTissueHeatmap}) and adult tissues (Figure \ref{fig:meanBetasByTissueTNMHeatmap}) at tRNA gene loci, consistent with the high rate of transcription at many tRNA gene loci.
We suspect that the tRNA genes largely remain unmethylated through development and that the moderate increases in DNAm that we are observing with age at these loci are being driven by changes arising primarily in older individuals.
...
This low baseline DNA methylation of the tRNA genes may also explain why we predominantly observe hypermethylation with age.
...
Our attempt to estimate tRNA transcription by identifying fragments witch may be derived from pre-tRNA sequences has serious limitations.
It assumes that pre-tRNA levels reflect the amount of tRNA transcription this may not be the case as pre-tRNAs are rapidly processed to mature tRNAs.
Our requirement for a read length of at least 40nt only has only a limited ability to distinguish full length tRNAs from tRNA derived small-RNAs, and the short read length of the data prevented the use of a higher threshold. Furthermore the limited number of read unambiguously mapping to a specific tRNA locus limits the utility of this approach for inferring the effects of epigenetic changes at a specific locus on the expresion at that locus.
tsRNA abundance has been associated with locus specific tRNA gene expression, in some cases independent of mature tRNA levels {[}\protect\hyperlink{ref-Torres2019}{242}{]}. This has important implications for the interpretation of our results given the multi-copy nature of genes like tRNA-iMet-CAT-1-4, as even if expression levels of mature iMet tRNAs are unaffected by changes in one copy's DNA methylation, these changes could still influence the levels of particular tsRNAs derived from specific tRNA loci.
...
Age is a significant risk factor across the breadth of chronic diseases, including cardiovascular, obesity-related, ophthalmic, musculoskeletal and neurological disorders {[}\protect\hyperlink{ref-Partridge2018}{226}{]}.
...
This epigenetic mechanism is crucial in repressing the large proportion of the human genome (\textasciitilde45\% {[}\protect\hyperlink{ref-Gregory2005}{342}{]}) that is comprised of repetitive or transposable elements {[}\protect\hyperlink{ref-Deniz2019}{343}{]}, {[}\protect\hyperlink{ref-Kazazian2017}{344}{]}.
It also classically leads to robust repression of gene expression through promoter DNA methylation {[}\protect\hyperlink{ref-Deaton2011}{345}{]}, and has more nuanced effects on expression within the gene body {[}\protect\hyperlink{ref-Hellman2007}{346}{]}, as well as influencing splicing {[}\protect\hyperlink{ref-Shukla2011}{347}{]} and transcription factor binding-sites (TFBSs) {[}\protect\hyperlink{ref-Blattler2014}{348}{]}, {[}\protect\hyperlink{ref-Yin2017}{51}{]}.

A significant decrease in DNA methylation with age was first observed with pioneering global measures {[}\protect\hyperlink{ref-Wilson1983}{90}{]}, in similar fashion to the reduced methylation seen in cancer tissue {[}\protect\hyperlink{ref-Gama-Sosa1983}{349}{]}.
This DNA methylation loss was seen to be strongly contributed to by the demethylation of repetitive elements {[}\protect\hyperlink{ref-Bollati2010}{350}{]}.
Random drift in the epigenetic state with age was also observed {[}\protect\hyperlink{ref-Bollati2010}{350}{]}, and more recent studies have identified targeted hypermethylation of specific functional regions, such as the promoters of polycomb target genes {[}\protect\hyperlink{ref-Teschendorff2010}{108}{]}, bivalent chromatin domains {[}\protect\hyperlink{ref-Rakyan2010}{106}{]} and the genomic loci of specific tRNA genes {[}\protect\hyperlink{ref-Acton2020}{225}{]}

Alu elements are the most successful transposon in terms of numbers within the human genome, totalling \textasciitilde1.19 million copies and comprising \textasciitilde10.7\% of the genomic sequence {[}\protect\hyperlink{ref-Dewannieux2003}{351}{]}, {[}\protect\hyperlink{ref-Deininger2011}{352}{]}.
This \textasciitilde300 bp primate-specific retrotransposon is a member of the short interspersed nuclear elements (SINEs) and is derived from the 7SL RNA gene {[}\protect\hyperlink{ref-Ullu1984}{353}{]}.
Alu elements arose \textasciitilde65 million years ago (MYA), with a peak in amplification around \textasciitilde40 MYA {[}\protect\hyperlink{ref-Ade2013}{354}{]}.
Non-LTR retrotransposons, which include Alus as well as L1 and SVA elements, are active in human.
However, Alu elements themselves are non-autonomous and need to commandeer a nearby L1 element's retrotransposition molecular machinery {[}\protect\hyperlink{ref-Cordaux2009}{355}{]}.
Alu insertion mutagenesis as well as Alu element mediated recombination account for 0.4\% of all human genetic disorders {[}\protect\hyperlink{ref-Kazazian2017}{344}{]}, {[}\protect\hyperlink{ref-Belancio2008}{356}{]}.

DNA methylation represses Alu elements and due to their sequences being rich in CpGs they in fact account for \textasciitilde25\% of all the CpGs in human genome (\textasciitilde7.5 million) {[}\protect\hyperlink{ref-Deininger2011}{352}{]}.
Alu repeats are predominately methylated across all normal tissues, and even in cancer cells they are the more resistant to hypomethylation than other repetitive elements, implying a strong pressure to maintain their epigenetic state {[}\protect\hyperlink{ref-Jorda2017}{357}{]}.
These elements are an abundant genetic resource of regulatory sequences with
numerous TFBSs residing within its canonical sequence {[}\protect\hyperlink{ref-Polak2006}{358}{]}.
They can influence gene expression {[}\protect\hyperlink{ref-Chen2017b}{359}{]}, {[}\protect\hyperlink{ref-RobertoFerrari2019}{360}{]} and there is evidence that some may possess enhancer activity {[}\protect\hyperlink{ref-Su2014}{361}{]}.
The deterioration of epigenomic repression can unmask latent regulatory function within repetitive elements {[}\protect\hyperlink{ref-Ward2013}{362}{]}, {[}\protect\hyperlink{ref-Chuong2017}{228}{]}, {[}\protect\hyperlink{ref-Xie2013}{363}{]}.
This has been clearly displayed as a pathogenic mechanism in cancer, with epigenetic reactivation of cryptic cis-regulatory elements (CREs) within transposons acting as oncogenic drivers {[}\protect\hyperlink{ref-Jang2019}{364}{]} , including Alu elements {[}\protect\hyperlink{ref-Rajendiran2016}{365}{]}.
There is the potential for these changes to also influence common non-malignant age-related diseases {[}\protect\hyperlink{ref-Chuong2017}{228}{]}, {[}\protect\hyperlink{ref-Payer2017}{366}{]}.
...
Hypermethylated and hypomethylated cytosines approximately equally drive these DNA methylation clocks, although these age-related increases or decreases in methylation are driven by distinct biological mechanisms {[}\protect\hyperlink{ref-Mozhui2017}{367}{]}, {[}\protect\hyperlink{ref-Wu2017}{60}{]}.
...
\item
  ...
  \tightlist
  \item
    Removed known polymorphic Alu in the human population {[}\protect\hyperlink{ref-Payer2017}{366}{]}
  \item
...
\item
  Enrichment Analysis - GREAT {[}\protect\hyperlink{ref-McLean2010}{371}{]}
\item
...
\tightlist
\item
  Elastic net regression with R package glmnet {[}\protect\hyperlink{ref-Friedman2010}{120}{]}, {[}\protect\hyperlink{ref-Engebretsen2019}{372}{]}
\end{itemize}
...
\item
  ...
  \item
    ?Remethylation Window {[}\protect\hyperlink{ref-Zhou2018}{373}{]}
  \end{itemize}
\end{itemize}
...
\tightlist
\item
  Ageing and genetics shared risk {[}\protect\hyperlink{ref-Zenin2019}{374}{]}
\item
...
\item
  ...
  \item
    Phewascatelog.org
  \item
    Denny et al Nat Biotech 2013 {[}\protect\hyperlink{ref-Denny2014}{375}{]}
  \item
    Bush NRG {[}\protect\hyperlink{ref-Bush2016}{376}{]}
  \item
    Wei et al.~Circulation 2018 {[}\protect\hyperlink{ref-Wei2018}{377}{]}
  \item
...
Excluded polymorphic Alus {[}\protect\hyperlink{ref-Payer2017}{366}{]}
...
271. Kennedy BK, Lamming DW: \textbf{The Mechanistic Target of Rapamycin: The Grand ConducTOR of Metabolism and Aging}. \emph{Cell Metabolism} 2016, \textbf{23}:990--1003\href{https://doi.org/10.1016/j.cmet.2016.05.009}{10.1016/j.cmet.2016.05.009}Available: \url{http://dx.doi.org/10.1016/j.cmet.2016.05.009}.
...
342. Gregory TR: \textbf{Synergy between sequence and size in large-scale genomics}. \emph{Nature Reviews Genetics} 2005, \textbf{6}:699--708\href{https://doi.org/10.1038/nrg1674}{10.1038/nrg1674}.

\leavevmode\hypertarget{ref-Deniz2019}{}%
343. Deniz Ö, Frost JM, Branco MR: \textbf{Regulation of transposable elements by DNA modifications}. \emph{Nature Reviews Genetics} 2019, \textbf{20}:417--431\href{https://doi.org/10.1038/s41576-019-0106-6}{10.1038/s41576-019-0106-6}.

\leavevmode\hypertarget{ref-Kazazian2017}{}%
344. Kazazian HH, Moran JV: \textbf{Mobile DNA in health and disease}. \emph{New England Journal of Medicine} 2017, \textbf{377}:361--370\href{https://doi.org/10.1056/NEJMra1510092}{10.1056/NEJMra1510092}.
