...
The criteria for being called an epigenetic clock laid out by Horvath & Raj [@Horvath2018] are that an r > 0.8 should be achieved by the clock.
...
Our sample is ~92% female which may explain the association with SNPs associated with increased likelihood of treatment with topical estradiol, and phenotypes of the female reproductive organs in the PheWeb results.
