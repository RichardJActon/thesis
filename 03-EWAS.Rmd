...
EWAS for bone mineral content at 6 and 8 years would be expected to produce similar results given that BMC at these ages are highly correlated (Figure \ref(fig:cor_8_6_plot)).

```{r cor_8_6_plot, fig.cap='(ref:cor_8_6_plot-Cap)', out.width='60%', fig.align = 'center', fig.show='hold', echo=FALSE}
knitr::include_graphics("figs/cor_8_6_plot.png")
```
(ref:cor_8_6_plot-Cap) Bone Mineral content at 6 and 8 years of are correlated with an $R^2 = 0.88$.
...
```
(ref:SWSstotbmcwhasa-Cap) Distribution of whole body (minus head) bone mineral content in kg at 6 years of age (n = 402), adjusted for sex and age, as measured by DXA.
