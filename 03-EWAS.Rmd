...
- developmental factors -> peak bone mass
- dev factors - vitamin D ~ calcium interaction either can be limiting or other low protein rats/prudent diet
- 
...
```{r VanStaa2001, fig.cap='(ref:VanStaa2001-Cap)', out.width='50%', fig.align = 'center', fig.show='hold', echo=FALSE}
...
Thus factors altering the peak bone mass and/or density will be important for modulating osteoporosis risk.
...
~~Calcium and vitamin D can become limiting for bone development, for example in Pune, India the consumption of calcium rich foods during pregnancy lead to higher total lumbar spine bone mineral content (BMC) and areal BMD in a population with high vitamin D [@Ganpule2006]. ~~
...
There is something of a north-south gradient in europe for hip fracture risk [@Holroyd2012; @Kanis2002] with countries in northern latitudes showing higher risk. 
Given the requirement for UVB light exposure in vitamin D synthesis it would be reasonable to suspect vitamin D levels might be responsible for this effect however international comparisons of vitamin D levels do not follow a simple north-south gradient with dietary and cultural factors impacting on vitamin D levels [@Prentice2008], this picture is further complicated by seasonal variation in vitamin D [@Cooper2016].
...
Calcium is needed for bone development... vitamin d or calcium can be limiting 
- Pune, India, calcium-rich foods during pregnancy -> higher total and lumbar spine BMC and areal BMD, high vitamin D [@Ganpule2006]
- north south gradient in european hip fracture risk - vitamin D?

[@Harvey2014b] - Osteoporosis: A Lifecourse Approach
[@Holroyd2012] - Epigenetic influences in the developmental origins of osteoporosis




cohort profile sws @Inskip2006

```{r Harvey2014bfig1, fig.cap='(ref:Harvey2014bfig1-Cap)', out.width='50%', fig.align = 'center', fig.show='hold', echo=FALSE}
...
An 'epigenome-wide' approach examining ~850k sites in the genome was carried out using the Illumina EPICmethylation bead chip array on umbilical cord tissue samples from participants in the MAVIDOS study (n=140). 
Results were compared with additional samples run on the Illumina 450k array (n=60), which covers only ~450k sites. 
...
Whilst there are several reference samples available for cord blood [@Cardenas2016; @DeGoede2015; @Bakulski2016; @Gervin2016], None were available to cord tissue at the time of the initial analysis

and one for cord tissue reference was recently published [@Lin2018]. 
