...
The methylation status of ancient DNA has even been characterised, for example, native American remains ranging in age from 230 to 4500 years wew measured using bisulfite sequencing [@Smith2015].
...
Stadler et al. categorised ...Mouse embryonic stem cells hidden markov model  [@Stadler2011]
...
Ziller et al. identified ~5.6 million CpGs dynamically regulated across diverse cell-types regions, these clustered into ~716,000 differentially methylated regions.
