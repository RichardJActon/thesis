...
The global population is ageing as is evident from the changeing shape of the world population pryamid (figure \@ref(fig:poppyramid)). The increase in average lifespan underlying this demographics shift is projected to continue in industrialised nations with a probability of >65% for woman and 85% for men [@Kontis2017] (figure \@ref(fig:Kontis2017-fig1)). Ageing is the main risk factor for cancer, cariovascular and neurodegerative diseases [@Niccoli2012]. Furthermore, morality from these conditions increases according to a logistic function with age (figure \@ref(fig:Belikov2019-fig1)) [@Belikov2019]. In addition to the noninfectious diseases, immunosenescene and frailty in old age contribute to an increased morality from infectious diseases, as figure \@ref(fig:Fleming2005-fig3) illustrates hospital admissions and deaths for respiratoiry disease during seasonal flu epidemics are dramatically higher in over 75s. Ageing is a common underlying risk factor for many conditions and as this would lead one to expect the number of concomitant disorders and the perportion of persons with multiple morbidities increases with age (figure \@ref(fig:Barnett2012-fig1)) [@Barnett2012].


```{r poppyramid, fig.cap='(ref:poppyramid-cap)', echo=FALSE}
knitr::include_graphics("figs/population-pryamids-1950-2019.png")
```

(ref:poppyramid-cap) Population pryamids for global population for A) 1950 and B) 2019 from [populationpyramid.net](populationpyramid.net)

```{r Kontis2017-fig1, fig.cap='(ref:Kontis2017-fig1-cap)', echo=FALSE}
knitr::include_graphics("figs/Kontis2017_fig1.jpg")
```

(ref:Kontis2017-fig1-cap) Median projected increase in life expectancy from birth in the period 2010 to 2030 for 35 industrial nations reproduced from Kontis et al. 2017 figure 1 [@Kontis2017].

```{r Belikov2019-fig1, fig.cap='(ref:Belikov2019-fig1-cap)', echo=FALSE}
knitr::include_graphics("figs/Belikov2019_fig1.jpg")
```

(ref:Belikov2019-fig1-cap)  reproduced from Belikov 2019 figure 1 [@Belikov2019].


```{r Fleming2005-fig3, fig.cap='(ref:Fleming2005-fig3-cap)', echo=FALSE}
knitr::include_graphics("figs/Fleming2005_fig3.jpg")
```

(ref:Fleming2005-fig3-cap) Median projected increase in life expectancy from birth in the period 2010 to 2030 for 35 industrial nations reproduced from Flemming et al. 2005 figure 3 [@Fleming2005].

```{r Barnett2012-fig1, fig.cap='(ref:Barnett2012-fig1-cap)', echo=FALSE}
knitr::include_graphics("figs/Barnett2012_fig1.jpg")
```

(ref:Barnett2012-fig1-cap) ... reproduced from Barnett et al. 2012 figure 1 [@Barnett2012].

- ageing population trends / disease burden
  - @Niccoli2012 - disease risk factor - fig 1
  - @Barnett2012 - multimorbidity - fig 1
  - @Kontis2017 - life expectancy increases fig 1
