...
The 2 tRNAs located in chr1_gl000192_random are tRNA-Gly-CCC-8-1 & tRNA-Asn-ATT-1-2 ([Supplementary File S1](docs/Supplementary_Files/hg19-tRNAs.bed)).
...
Primer design was performed using 'methPrimer' [@Li2002] ([Supplementary File S2](docs/Supplementary_Files/Targeted_BiS-seq_Primers.txt)). 
...
Selecting those probes overlapping tRNA genes yielded 73,403 data points across 19 tissues with an age range of 15-90yrs (median 63.4) ([Supplementary File S3](docs/Supplementary_Files/TCGA_samples_used.tsv))
...
gws <- 4.338717e-09
sws <- 0.05 / 598
medipWinbytRNAres <- readRDS("docs/Supplementary_Files/medipWinbytRNAres.Rds")
medipWinbytRNAres %>%
    tibble::as_tibble() %>%
...
These three are tRNA-Asp-GTC-1-12, tRNA-Ile-AAT-1-4, tRNA-Glu-TTC-1-3 (Figure \ref{fig:mouse}). Full Age model Results are available in [Supplementary File S4](docs/Supplementary_Files/SF4_mouse_tRNA_age_models.xlsx).
