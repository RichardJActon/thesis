...
\addcontentsline{toc}{section}{Research Thesis: Declaration of Authorship}
...
The mechanisms of the demethylation of DNA were more recently characterised than those which govern its methylation {[}\protect\hyperlink{ref-Tahiliani2009}{98},\protect\hyperlink{ref-Ito2011}{48}{]}.
...
Sequence features of particular importance to determining DNA methylation status are; transcription factor and other DNA binding protein recognition motifs, and CpG density {[}\protect\hyperlink{ref-Lienert2011}{102},\protect\hyperlink{ref-Ziller2013}{86}{]}.
...
{[}\protect\hyperlink{ref-Sharif2007}{112},\protect\hyperlink{ref-Bostick2007}{95},\protect\hyperlink{ref-Arita2008}{113},\protect\hyperlink{ref-Liu2013b}{114}{]}.
...
\item
  ...
  Though relative methylation levels remain effective in identifying differentially methylated regions when using these methods alone {[}\protect\hyperlink{ref-Bock2010}{131},\protect\hyperlink{ref-Maunakea2010}{81}{]}.
\item
...
This could result from the exposure of homologous sequences presenting increased opportunities for erroneous breakpoint repair or recombination between similar sequences in different parts of the genome {[}\protect\hyperlink{ref-Feinberg2004}{145},\protect\hyperlink{ref-Jenkinson2017}{118}{]}.
...
Fahy et al.~showed in a small exploratory study that they could reduce epigenetic age, as measured by four different epigenetic clocks {[}\protect\hyperlink{ref-Fahy2019}{197}{]}.
...
Promisingly, differences in interventions known to effect longevity in model organisms such as caloric restriction, rapamycin treatment, ovariectomy in female mice, and genetically long lived mouse strains {[}\protect\hyperlink{ref-Gensous2019}{201},\protect\hyperlink{ref-Wang2017a}{202},\protect\hyperlink{ref-Stubbs2017}{186}{]} have consistently shown decreased epigenetic ageing under the pro-longevity conditions.
...
This array contained \textasciitilde1.5k probes covering 371 genes with a strong focus of cancer-related genes {[}\protect\hyperlink{ref-Bibikova2006}{149}{]}.
...
The 450k array systematically underestimates the methylation level in highly methylated regions {[}\protect\hyperlink{ref-Clark2012}{213}{]}.
...
On the Illumina methylation arrays control probes ({[}\protect\hyperlink{ref-Illumina2015}{221}{]} p226) are located at non-CpG cytosines to assay the conversion efficiency for use in quality control assessment of array data.
...
Better even that input controls is to couple MeDIP-seq with MRE-seq which makes use of methylation-sensitive restriction digests to enrich for unmethylated DNA {[}\protect\hyperlink{ref-Maunakea2010}{81}{]}.
...
In conjunction these complementary sequencing technologies provide an improved ability to discern absolute methylation levels compared to MeDIP-seq alone {[}\protect\hyperlink{ref-Bock2010}{131}{]}.
...
The above-described processing steps for Methylated DNA Immunoprecipitation sequencing (MeDIP-seq) data used here have been previously described in Bell et al. {[}\protect\hyperlink{ref-Bell2016}{209},\protect\hyperlink{ref-Bell2017a}{107}{]}.
...
\caption{\textbf{Bisulfite sequencing alignment process} \textbf{A)} Unmethylated cytosines are converted to uracil in the bisulfite conversion process these are rendered as thymidine as T is used in the PCR amplification following bisulfite conversion. Following the conversion of a C to A T its corresponding G is swapped for an A in the complementary strand. The Genome is converted in silico to permit the alignment of these altered bases. Thus there is the C to T converted and a G to A converted genome each to which has two strands totalling 4 possible alignment targets for the converted reads. \textbf{B)} The unique best alignment for a read is determined from this set and mismatches of C in this alignment are used to call the methylation state. (Reproduced from Krueger et al. {[}\protect\hyperlink{ref-Krueger2011}{236}{]})}\label{fig:Krueger2011BismarkAlignment}
\end{figure}
...
Winter births saw a mean difference in BMC between treatment groups of 5.5 g {[}95\% CI 1.8-9.1{]}; p=0.004) and for BMD a mean difference 0.01 gcm-2 {[}0.00-0.02{]}; p=0.04 {[}\protect\hyperlink{ref-Cooper2016}{208}{]}.
...
When epigenetics is facilitative it has a genetic bias for a particular state but which is subject to environmental influences including the intracellular environment {[}\protect\hyperlink{ref-Richards2006}{265}{]}.
...
\hypertarget{primary-questions}{%
\section{Primary Questions}\label{primary-questions}}
...
What the DNA methylation changes with vitamin D and Bone outcomes at \emph{RXRA} and \emph{CDKN2A} can be observed?
...
\tightlist
\item
  MAVIDOS phase I, cord tissue, results (EPIC n = 140, 450k n = 60), EWAS outcomes:
\end{enumerate}
...
\tightlist
\item
  MAVIDOS phase II, cord tissue, results (EPIC n = 237), EWAS outcomes:
\end{enumerate}
...
In the analysis of the SWS cord blood data the ``andrews and bakulski cord blood'' reference panel {[}\protect\hyperlink{ref-Bakulski2016}{275}{]} was used in \texttt{meffil} for cell-type composition estimation.
...
\hypertarget{combined-mavidos-summary-data}{%
\subsection{Combined MAVIDOS Summary data}\label{combined-mavidos-summary-data}}
...
\caption{\label{tab:mavidosoveralltab}Summary statistics for variables used in the SWS EWAS. Blood cell count information is estimated based on the methylation data as described in the methods.}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:mavidosbysextab}Summary statistics for variables used in the MAVIDOS EWAS divided by the sex of the child. Blood cell count information is estimated based on the methylation data as described in the methods. n=375, Female n=170, Male n=205.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
...
\midrule
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{Woman's Age at Time of Birth} & \cellcolor{gray!6}{31.14} & \cellcolor{gray!6}{31.36} & \cellcolor{gray!6}{19.25} & \cellcolor{gray!6}{41.78}\\
\cmidrule{1-6}
F & EP: Woman's BMI & 26.41 & 24.85 & 18.80 & 41.16\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{True if Yes in Late (dcrsmok) or early (acrsmok) pregnancy , NA if NA in both, FALSE if both No or No \& NA} & \cellcolor{gray!6}{0.11} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{1.00}\\
\cmidrule{1-6}
F & Obst: Gestational age (weeks) & 40.08 & 40.29 & 34.57 & 42.14\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{B cells} & \cellcolor{gray!6}{0.03} & \cellcolor{gray!6}{0.03} & \cellcolor{gray!6}{0.01} & \cellcolor{gray!6}{0.07}\\
\cmidrule{1-6}
F & CD4+ T-cells & 0.01 & 0.00 & 0.00 & 0.07\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{CD8+ T-cells} & \cellcolor{gray!6}{0.01} & \cellcolor{gray!6}{0.01} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.07}\\
\cmidrule{1-6}
F & Granulocytes & 0.07 & 0.04 & 0.00 & 0.51\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{Monocytes} & \cellcolor{gray!6}{0.02} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.17}\\
\cmidrule{1-6}
F & Natural Killer Cells & 0.02 & 0.02 & 0.00 & 0.06\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{Endothelial} & \cellcolor{gray!6}{0.13} & \cellcolor{gray!6}{0.13} & \cellcolor{gray!6}{0.07} & \cellcolor{gray!6}{0.19}\\
\cmidrule{1-6}
F & Epithelial & 0.17 & 0.17 & 0.03 & 0.37\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{Stromal} & \cellcolor{gray!6}{0.56} & \cellcolor{gray!6}{0.61} & \cellcolor{gray!6}{0.14} & \cellcolor{gray!6}{0.79}\\
\cmidrule{1-6}
F & cam: 34 week VitD & 53.87 & 53.58 & 11.50 & 114.50\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{cam: 11 week VitD} & \cellcolor{gray!6}{45.35} & \cellcolor{gray!6}{45.53} & \cellcolor{gray!6}{14.55} & \cellcolor{gray!6}{79.60}\\
\cmidrule{1-6}
F & 4yr DXA: Subtotal BMC (g) & 355.30 & 353.05 & 247.53 & 439.21\\
\cmidrule{1-6}
\cellcolor{gray!6}{F} & \cellcolor{gray!6}{4yr DXA: Subtotal BMD (g/cm sq)} & \cellcolor{gray!6}{0.46} & \cellcolor{gray!6}{0.46} & \cellcolor{gray!6}{0.38} & \cellcolor{gray!6}{0.54}\\
\cmidrule{1-6}
M & Woman's Age at Time of Birth & 30.28 & 31.41 & -58.30 & 41.95\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{EP: Woman's BMI} & \cellcolor{gray!6}{26.18} & \cellcolor{gray!6}{25.14} & \cellcolor{gray!6}{17.54} & \cellcolor{gray!6}{41.68}\\
\cmidrule{1-6}
M & True if Yes in Late (dcrsmok) or early (acrsmok) pregnancy , NA if NA in both, FALSE if both No or No \& NA & 0.05 & 0.00 & 0.00 & 1.00\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{Obst: Gestational age (weeks)} & \cellcolor{gray!6}{40.22} & \cellcolor{gray!6}{40.43} & \cellcolor{gray!6}{35.86} & \cellcolor{gray!6}{42.57}\\
\cmidrule{1-6}
M & B cells & 0.03 & 0.03 & 0.01 & 0.11\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{CD4+ T-cells} & \cellcolor{gray!6}{0.01} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.07}\\
\cmidrule{1-6}
M & CD8+ T-cells & 0.01 & 0.01 & 0.00 & 0.08\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{Granulocytes} & \cellcolor{gray!6}{0.05} & \cellcolor{gray!6}{0.04} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.39}\\
\cmidrule{1-6}
M & Monocytes & 0.01 & 0.00 & 0.00 & 0.16\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{Natural Killer Cells} & \cellcolor{gray!6}{0.02} & \cellcolor{gray!6}{0.02} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{0.11}\\
\cmidrule{1-6}
M & Endothelial & 0.13 & 0.13 & 0.05 & 0.20\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{Epithelial} & \cellcolor{gray!6}{0.16} & \cellcolor{gray!6}{0.16} & \cellcolor{gray!6}{0.02} & \cellcolor{gray!6}{0.42}\\
\cmidrule{1-6}
M & Stromal & 0.60 & 0.64 & 0.14 & 0.86\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{cam: 34 week VitD} & \cellcolor{gray!6}{55.07} & \cellcolor{gray!6}{56.88} & \cellcolor{gray!6}{10.70} & \cellcolor{gray!6}{119.00}\\
\cmidrule{1-6}
M & cam: 11 week VitD & 44.39 & 44.10 & 14.40 & 90.20\\
\cmidrule{1-6}
\cellcolor{gray!6}{M} & \cellcolor{gray!6}{4yr DXA: Subtotal BMC (g)} & \cellcolor{gray!6}{357.01} & \cellcolor{gray!6}{352.52} & \cellcolor{gray!6}{237.30} & \cellcolor{gray!6}{455.94}\\
\cmidrule{1-6}
M & 4yr DXA: Subtotal BMD (g/cm sq) & 0.48 & 0.48 & 0.39 & 0.57\\
\bottomrule
\end{tabular}}
\end{table}
...
The predicted sex (performed with \texttt{meffil}) of the samples generated using sex chromosome probe intensities was checked against that in the sample annotation and two mismatches were found.
...
{\centering \includegraphics[width=1\linewidth]{figs/MAVIDOSbmcEPICewasManhattanSVA} 
...
{\centering \includegraphics[width=1\linewidth]{figs/MAVIDOSccEPICewasManhattanSVA} 
...
{\centering \includegraphics[width=1\linewidth]{figs/MAVIDOSmVitD34EPICewasManhattanSVA} 
...
{\centering \includegraphics[width=1\linewidth]{figs/MAVIDOSdifVDEPICewasManhattanSVA} 
...
{\centering \includegraphics[width=1\linewidth]{figs/MAVIDOSIInsubtotbmcEPICewasManhattanSVA} 
...
\hypertarget{rxra-cdkn2a}{%
\subsubsection{RXRA \& CDKN2A}\label{rxra-cdkn2a}}

None of the probes associated with the \emph{RXRA} and \emph{CDKN2A} loci exhibited genome wide significant changes in DNA methylation however nominally significant (p \textless{} 0.05) changes are observed at some of the probes within these genes in the MAVIDOS phase II analysis dataset.
Table \ref{tab:CDKN2A-RXRA-top} lists these model results for maternal vitamin D levels and table \ref{tab:CDKN2A-RXRA-top-bone} for bone mineral content and density. \protect\hyperlink{appRXRACDKN2A}{Appendix} \ref{appRXRACDKN2A} provides the complete list of these model results not just the nominally significant results listed here.

\begin{table}

\caption{\label{tab:CDKN2A-RXRA-top}Results for modelling Maternal Vitamin D levels with umbilical cord tissue DNA methylation levels and covariates at probes associated with the \emph{RXRA} and \emph{CDKN2A} genes. vit D: maternal circulating vitamin D nmol/l}
\centering
\resizebox{\linewidth}{!}{
...
\midrule
 &  &  & Chr9: 21,968,233- 21,968,233 & cg12840719 & 230.3170 & 0.0066\\
\cmidrule{4-7}
...
\cmidrule{4-7}
 & \multirow{-5}{*}{\raggedright\arraybackslash Corrected} &  & Chr9: 21,971,256- 21,971,256 & cg08686553 & 96.1148 & 0.0378\\
\cmidrule{2-2}
\cmidrule{4-7}
 &  &  & Chr9: 21,968,233- 21,968,233 & cg12840719 & 180.7349 & 0.0147\\
\cmidrule{4-7}
 & \multirow{-2}{*}{\raggedright\arraybackslash Uncorrected} & \multirow{-7}{*}{\raggedright\arraybackslash CDKN2A} & Chr9: 21,986,062- 21,986,062 & cg00550721 & -50.0384 & 0.0411\\
\cmidrule{2-7}
 &  &  & Chr9:137,329,237-137,329,237 & cg14344989 & -92.4988 & 0.0005\\
\cmidrule{4-7}
...
\cmidrule{4-7}
 & \multirow{-26}{*}{\raggedright\arraybackslash Corrected} &  & Chr9:137,225,311-137,225,311 & cg13689699 & -49.7538 & 0.0487\\
\cmidrule{2-2}
\cmidrule{4-7}
 &  &  & Chr9:137,266,722-137,266,722 & cg06831947 & -93.4263 & 0.0020\\
\cmidrule{4-7}
...
\cmidrule{4-7}
\multirow{-45}{*}{\raggedright\arraybackslash 11 weeks} & \multirow{-12}{*}{\raggedright\arraybackslash Uncorrected} & \multirow{-38}{*}{\raggedright\arraybackslash RXRA} & Chr9:137,272,766-137,272,766 & cg13847322 & -53.5243 & 0.0433\\
\cmidrule{1-7}
 &  & CDKN2A & Chr9: 21,975,622- 21,975,622 & cg25339269 & -472.4791 & 0.0081\\
\cmidrule{3-7}
 &  &  & Chr9:137,217,473-137,217,473 & cg14204281 & -258.5922 & 0.0259\\
\cmidrule{4-7}
 &  &  & Chr9:137,301,635-137,301,635 & cg18566083 & 114.9198 & 0.0483\\
\cmidrule{4-7}
 & \multirow{-4}{*}{\raggedright\arraybackslash Corrected} &  & Chr9:137,215,364-137,215,364 & cg04329455 & 99.9363 & 0.0489\\
\cmidrule{2-2}
\cmidrule{4-7}
\multirow{-5}{*}{\raggedright\arraybackslash 34 weeks} & Uncorrected & \multirow{-4}{*}{\raggedright\arraybackslash RXRA} & Chr9:137,299,285-137,299,285 & cg13865488 & 59.8832 & 0.0427\\
\bottomrule
\multicolumn{7}{l}{\textsuperscript{a} Corrected: vit D \textasciitilde{} beta + wageb + Sex + awbmi + smokpreg + egest + Bcell + CD4T + CD8T + Gran + Mono + NK + Endothelial + Epithelial + Stromal, Uncorrected: vit D \textasciitilde{} beta, beta: methylation value}\\
\end{tabular}}
\end{table}
...
\caption{\label{tab:CDKN2A-RXRA-top-bone}Results for modelling bone mineral content and density at 4 years of age with umbilical cord tissue DNA methylation levels and covariates at probes associated with the \emph{RXRA} and \emph{CDKN2A} genes. Corrected: BMC/D \textasciitilde{} beta + wageb + Sex + awbmi + smokpreg + egest + Bcell + CD4T + CD8T + Gran + Mono + NK + Endothelial + Epithelial + Stromal, Uncorrected: BMC/D \textasciitilde{} beta, beta: methylation value, BMC/D Bone Mineral Content (g)/Density(gcm-2) at 4 years (DXA)`}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{lllllrr}
...
\midrule
 &  &  & Chr9: 21,991,666- 21,991,666 & cg13109095 & -353.4675 & 0.0270\\
\cmidrule{4-7}
 &  &  & Chr9: 21,975,243- 21,975,243 & cg16468520 & 1968.4218 & 0.0347\\
\cmidrule{4-7}
 & \multirow{-3}{*}{\raggedright\arraybackslash Corrected} &  & Chr9: 21,975,023- 21,975,023 & cg26269171 & 906.1528 & 0.0468\\
\cmidrule{2-2}
\cmidrule{4-7}
 &  &  & Chr9: 21,975,243- 21,975,243 & cg16468520 & 2174.9837 & 0.0117\\
\cmidrule{4-7}
...
\cmidrule{4-7}
 & \multirow{-6}{*}{\raggedright\arraybackslash Uncorrected} & \multirow{-9}{*}{\raggedright\arraybackslash CDKN2A} & Chr9: 21,974,704- 21,974,704 & cg13601799 & 388.9265 & 0.0462\\
\cmidrule{2-7}
 &  &  & Chr9:137,232,372-137,232,372 & cg14462321 & -232.0554 & 0.0130\\
\cmidrule{4-7}
 &  &  & Chr9:137,210,392-137,210,392 & cg03416552 & 202.2096 & 0.0197\\
\cmidrule{4-7}
 & \multirow{-3}{*}{\raggedright\arraybackslash Corrected} &  & Chr9:137,299,436-137,299,436 & cg14654324 & 136.6815 & 0.0383\\
\cmidrule{2-2}
\cmidrule{4-7}
 &  &  & Chr9:137,232,372-137,232,372 & cg14462321 & -206.8839 & 0.0050\\
\cmidrule{4-7}
 &  &  & Chr9:137,299,436-137,299,436 & cg14654324 & 137.8739 & 0.0319\\
\cmidrule{4-7}
 &  &  & Chr9:137,329,237-137,329,237 & cg14344989 & -88.5216 & 0.0379\\
\cmidrule{4-7}
\multirow{-16}{*}{\raggedright\arraybackslash BMC} & \multirow{-4}{*}{\raggedright\arraybackslash Uncorrected} & \multirow{-7}{*}{\raggedright\arraybackslash RXRA} & Chr9:137,291,076-137,291,076 & cg02766323 & -360.6465 & 0.0439\\
\cmidrule{1-7}
 & Corrected &  & Chr9: 21,975,243- 21,975,243 & cg16468520 & 1.5214 & 0.0355\\
\cmidrule{2-2}
\cmidrule{4-7}
 &  &  & Chr9: 21,975,243- 21,975,243 & cg16468520 & 1.5416 & 0.0259\\
\cmidrule{4-7}
 & \multirow{-2}{*}{\raggedright\arraybackslash Uncorrected} & \multirow{-3}{*}{\raggedright\arraybackslash CDKN2A} & Chr9: 21,974,704- 21,974,704 & cg13601799 & 0.3137 & 0.0447\\
\cmidrule{2-7}
 &  &  & Chr9:137,232,372-137,232,372 & cg14462321 & -0.1705 & 0.0188\\
\cmidrule{4-7}
...
\cmidrule{4-7}
 & \multirow{-6}{*}{\raggedright\arraybackslash Corrected} &  & Chr9:137,210,289-137,210,289 & cg01557614 & 0.1434 & 0.0457\\
\cmidrule{2-2}
\cmidrule{4-7}
 &  &  & Chr9:137,232,372-137,232,372 & cg14462321 & -0.1758 & 0.0029\\
\cmidrule{4-7}
...
\cmidrule{4-7}
\multirow{-15}{*}{\raggedright\arraybackslash BMD} & \multirow{-6}{*}{\raggedright\arraybackslash Uncorrected} & \multirow{-12}{*}{\raggedright\arraybackslash RXRA} & Chr9:137,228,542-137,228,542 & cg04875697 & -0.2058 & 0.0438\\
\bottomrule
\end{tabular}}
\end{table}
...
The result that 25 of 27 probes with nominally significant changes in DNA methylation are for decreasing methylation with increased vitamin D is consistent with the lower methylation in the offspring of the supplemented mothers in the original publication on the \emph{RXRA} changes {[}\protect\hyperlink{ref-Harvey2014d}{263}{]}, Figure \ref{fig:RXRA-probes-vitD-11-sig}.
...
{\centering \includegraphics[width=0.8\linewidth]{figs/RXRA_probes_vitD_11_sig} 

}

\caption{\emph{RXRA} gene associated probes showing nominally significant (p\textless0.05) changes in DNA methylation with maternal vitamin D at 11 weeks gestation}\label{fig:RXRA-probes-vitD-11-sig}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{figs/RXRA_probes_vitD_34_sig} 

}

\caption{\emph{RXRA} gene associated probes showing nominally significant (p\textless0.05) changes in DNA methylation with maternal vitamin D at 34 weeks gestation}\label{fig:RXRA-probes-vitD-34-sig}
\end{figure}



The inverse relationship between DNA methylation and bone mineral content / density in the \emph{ANRIL} promoter region of \emph{CDKN2A} is not seen in the majority of \emph{CDKN2A} probes which show nominally significant changes with bone mineral content / Density in this analysis.
...
{\centering \includegraphics[width=0.6\linewidth]{figs/CDKN2A_probes_bmc_sig} 

}

\caption{\emph{CDKN2A} gene associated probes showing nominally significant (p\textless0.05) changes in DNA methylation with bone mineral density at 4 years}\label{fig:CDKN2A-probes-bmc-sig}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{figs/CDKN2A_probes_bmd_sig} 

}

\caption{\emph{CDKN2A} gene associated probes showing nominally significant (p\textless0.05) changes in DNA methylation with bone mineral density at 4 years}\label{fig:CDKN2A-probes-bmd-sig}
\end{figure}



These results do not correspond to the same CpGs examined in the previous studies, either in the case of \emph{RXRA} {[}\protect\hyperlink{ref-Harvey2014d}{263}{]} or \emph{CDKN2A} {[}\protect\hyperlink{ref-Curtis2017}{264}{]}.
...
In the case of \emph{RXRA} these results appear somewhat supportive of the previous observation that there is lower methylation at higher vitamin D levels at least when considering only the 11 weeks gestation data. Whereas the \emph{CDKN2A} results do not support the previous finding of an inverse relationship between DNA methylation and bone mineral content / density at the loci which they target.
...
\caption{\label{tab:swsoveralltab}Summary statistics for variables used in the SWS EWAS. Blood cell count information is estimated based on the methylation data as described in the methods. (Ob.) obstetric exam, (init.) initial survey.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{lrrrr}
...
\caption{\label{tab:swsbysextab}Summary statistics for variables used in the SWS EWAS divided by the sex of the child. Blood cell count information is estimated based on the methylation data as described in the methods. n = 464, Female n=226, Male n=238. (Ob.) obstetric exam, (init.) initial survey.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{llrrrr}
...
Sex & Description & mean & median & min & max\\
\midrule
 & Ob: Woman's age at child's birth & 31.97 & 32.23 & 23.99 & 38.12\\
\cmidrule{2-6}
...
\cmidrule{2-6}
\multirow{-15}{*}{\raggedright\arraybackslash Female} & 6yr PQCT: 38\% - Cortical density (mg/cm3) & 1039.99 & 1041.40 & 949.90 & 1110.90\\
\cmidrule{1-6}
 & Ob: Woman's age at child's birth & 31.27 & 31.80 & 24.17 & 37.73\\
\cmidrule{2-6}
...
\cmidrule{2-6}
\multirow{-15}{*}{\raggedright\arraybackslash Male} & 6yr PQCT: 38\% - Cortical density (mg/cm3) & 1031.69 & 1030.10 & 961.00 & 1111.10\\
\bottomrule
\end{tabular}}
\end{table}
...
\caption{Predicted sex of each sample based on the sex chromosome copy numbers inferred from probe intensities for the EPIC array data. Mismatches between the predicted sex and that asserted in the sample annotation metadata are shown in red. Plot generated by \texttt{meffil} QC report.}\label{fig:SWSqcEPICsexMismatch}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{figs/cor_8_6_plot} 

}

\caption{Bone Mineral content at 6 and 8 years of are correlated with an \(R^2 = 0.88\).}\label{fig:cor-8-6-plot}
\end{figure}
...
\caption{Distribution of whole body (minus head) bone mineral content in kg (ttotbmcwhasa) at 8 years of age (n = 408), adjusted for sex and age, as measured by DXA.}\label{fig:SWSttotbmcwhasa}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figs/SWSttotbmcwhasaEPICewasManhattanAll} 
...
\caption{Distribution of whole body (minus head) bone mineral content in kg (stotbmcwhasa) at 6 years of age (n = 402), adjusted for sex and age, as measured by DXA.}\label{fig:SWSstotbmcwhasa}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figs/SWSstotbmcwhasaEPICewasManhattanAll} 
...
\caption{Distribution of periosteal circumference at 38\% from the distal end of the tibia (mm) at 6 years of age (s3peric), adjusted for sex and age, as measured by PQCT (n = 141).}\label{fig:SWSs3peric}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figs/SWSs3pericEPICewasManhattanAll} 
...
\caption{Distribution of cortical density at 38\% from the distal end of the tibia (\(mg~cm^{-3}\)) at 6 years of age (s3crtden), as measured by PQCT (n = 141).}\label{fig:SWSs3crtden}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figs/SWSs3crtdenEPICewasManhattanAll} 
...
The advent of high-throughput DNAm arrays {[}\protect\hyperlink{ref-Sandoval2011}{291},\protect\hyperlink{ref-Teschendorff2010}{155},\protect\hyperlink{ref-Hannum2013}{167}{]} has elucidated more detailed patterns of ageing related changes in DNAm.
The identification of precise individual CpG sites that exhibit consistent changes with age enabled the construction of predictors of chronological age known as epigenetic or DNAm `clocks' {[}\protect\hyperlink{ref-Hannum2013}{167},\protect\hyperlink{ref-Horvath2013}{168},\protect\hyperlink{ref-Levine2018}{193},\protect\hyperlink{ref-Horvath2018a}{292},\protect\hyperlink{ref-Lu2019}{194}{]}.
...
Four main types of tsRNAs have been identified, these are 5' tRNA halves, 3' tRNA halves, and the two main types of tRNA derived fragments (tRFs), the \textasciitilde18bp and the \textasciitilde22bp sizes {[}\protect\hyperlink{ref-Torres2019}{331}--\protect\hyperlink{ref-Xu2017a}{333}{]}.
...
Also, tRNAs are a major target for `epitranscriptomic' modification, with an average of 11-13 modifications per tRNA {[}\protect\hyperlink{ref-Wilusz2015}{349},\protect\hyperlink{ref-Schimmel2017}{340}{]}, some of which stop polymerases from elongating or alter base pairing, creating further mapping challenges.
...
\hypertarget{primary-questions-1}{%
\section{Primary questions}\label{primary-questions-1}}
...
The participants were aged between 16 and 82 years, with a median of age at sampling of \textasciitilde55 years for 4350 methylomes taken from 3652 unique participants some of whom where sampled more than once. (cohort profile {[}\protect\hyperlink{ref-Moayyeri2013}{232}{]}).
The majority of samples 4054 are female and 270 are male.
3001 have full blood counts.
These individuals originate from 1933 unique families.
There are 1234 monozygotic (MZ) twin pairs (2468 individuals), and 458 dizygotic (DZ) twin pairs (916 individuals).
See also the \protect\hyperlink{Participants}{participants section in general Methods} \ref{Participants}.
...
Samples from participants aged 4 and 28 years are from the MAVIDOS {[}\protect\hyperlink{ref-Harvey2012a}{207}{]} study, a randomised controlled trial of the effect of maternal vitamin D supplementation of the bone health of their offspring.
Participants aged 63 and 78 years are from the Hertfordshire cohort study, which consists of individuals originally recruited in the 1980's for a study of the impact of birth weight on heart attack risk because high quality records of their birth weights and other useful data had been recorded in the 1920s \& 30s {[}\protect\hyperlink{ref-Syddall2005}{356}{]}.
...
Thus, the total number of participants was 190 (see Table \ref{tab:poolSummaryTable}).
...
\subsection{tRNA Gene coordinates and other annotation information}\label{tRNAanno}}

Genomic coordinates of all tRNA genes including some likely pseudogenes were downloaded from GtRNAdb {[}\protect\hyperlink{ref-Chan2009}{304}{]}.
The 2 tRNAs located in chr1\_gl000192\_random are tRNA-Gly-CCC-8-1 \& tRNA-Asn-ATT-1-2 (The tRNA annotation used is provided in \protect\hyperlink{apptRNAanno}{appendix} \ref{apptRNAanno}).
...
107 tRNA genes were excluded from blacklisted regions of hg19 {[}\protect\hyperlink{ref-Amemiya2019}{357}{]}, that is to say regions of the genome which have ``anomalous, unstructured, or high signal in next-generation sequencing experiments independent of cell line or experiment.''
...
The Methylated DNA Immunoprecipitation sequencing (MeDIP-seq) data was processed as previously described {[}\protect\hyperlink{ref-Bell2016}{209},\protect\hyperlink{ref-Bell2017a}{107}{]} and detailed in \protect\hyperlink{MeDIPseq}{Methods} \ref{MeDIPseq}.
...
This is approximately 12 million windows for 4350 samples, or \textasciitilde52 billion data points.
...
CpGs residing within moderate CpG density loci are the most dynamic in the genome {[}\protect\hyperlink{ref-Ziller2013}{86}{]} and CpG dense CpG island regions include specific ageing-related changes {[}\protect\hyperlink{ref-Teschendorff2010}{155},\protect\hyperlink{ref-Rakyan2010}{153},\protect\hyperlink{ref-Bell2016}{209}{]}.
...
\caption{CpG Density is higher in windows directly overlapping tRNA genes compared to that of non-tRNA overlapping windows in arbitrary flanking sequences (+/-5kb). This difference in CpG density between tRNA loci and other regions of the genome is a potential source of bias if age related DNA methylation changes vary with CpG density which they may as baseline DNA methylation levels also vary with CpG density.}\label{fig:CpGcountBGvstRNAPlot}
\end{figure}
...
The individual were age matched at approximately 4, 28, 63, and 78 year timepoints (Table \ref{tab:poolSummaryTable})
...
\caption{\label{tab:poolSummaryTable}Summary information on participants in each pool.}
\centering
\begin{tabular}[t]{lrlrrr}
\toprule
Pool & Mean Age & Sex & Min Age & Max Age & n\\
\midrule
\multicolumn{1}{c}{Pool 1} & 4.07 & Male & 3.99 & 4.38 & 20\\
\multicolumn{1}{c}{Pool 2} & 4.09 & Female & 3.99 & 4.36 & 20\\
\multicolumn{1}{c}{Pool 3} & 28.07 & Female & 25.87 & 29.80 & 25\\
\multicolumn{1}{c}{Pool 4} & 28.23 & Female & 26.05 & 30.01 & 25\\
\multicolumn{1}{c}{Pool 5} & 63.40 & Female & 62.80 & 63.80 & 25\\
\multicolumn{1}{c}{Pool 6} & 63.26 & Female & 62.70 & 63.70 & 25\\
\multicolumn{1}{c}{Pool 7} & 77.96 & Female & 75.50 & 80.50 & 25\\
...
Primer design was performed using `methPrimer' {[}\protect\hyperlink{ref-Li2002}{237}{]} (Primer sequences are provided in \protect\hyperlink{apptRNAprimers}{appendix} \ref{apptRNAprimers}).
...
These data were available for this analysis in a pre-processed form, Methylation `beta' values subject to beta-mixture quantile normalisation (BMIQ) as previously described {[}\protect\hyperlink{ref-Bell2016}{209},\protect\hyperlink{ref-Bell2017a}{107}{]}.
...
Epilogos chromatin segmentation data {[}\protect\hyperlink{ref-Meuleman2019}{368},\protect\hyperlink{ref-Ernst2011}{359}{]} was downloaded for the tRNA gene regions +/- 200bp from \url{https://explore.altius.org/tabix/epilogos/hg19.15.Blood_T-cell.KL.gz} using the \texttt{tabix} utility.
...
Selecting those probes overlapping tRNA genes yielded 73,403 data points across 19 tissues with an age range of 15-90yrs (median 63.4) (A complete list of TCGA sample used is provided in \protect\hyperlink{appTCGA}{appendix} \ref{appTCGA})
...
\caption{\label{tab:GWSBBtRNAsTab}Study-wide significantly hypermethylating tRNAs in blood cell-type and batch corrected model MeDIP-seq. With Corresponding results in Twins UK 450k array (blood cell-type corrected) and targeted bisulfite sequencing results. Age models for array and targeted BiS-seq were calculated using all probes / CpGs overlapping the indicated tRNA gene. `Slope' corresponds to the beta value for methylation in the linear model, orange colouring indicates hypermethylation and blue hypomethylation. p-values coloured such that low values are dark blue and high values are yellow. blank grey cells indicate missing data.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{llllllll}
\toprule
\multicolumn{2}{c}{ } & \multicolumn{2}{c}{MeDIP} & \multicolumn{2}{c}{450k Array} & \multicolumn{2}{c}{Targeted BiS-seq} \\
\cmidrule(l{3pt}r{3pt}){3-4} \cmidrule(l{3pt}r{3pt}){5-6} \cmidrule(l{3pt}r{3pt}){7-8}
tRNA & Window &  Slope &  p-value &  Slope  &  p-value  &   Slope &   p-value\\
\midrule
tRNA-Gln-CTG-7-1 & Chr1:147,800,750-147,801,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.84}}} & \cellcolor[HTML]{DFCA5F}{\textcolor{white}{\textbf{2.60e-05}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
 & Chr2:131,094,500-131,095,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.11}}} & \cellcolor[HTML]{555B6D}{\textcolor{white}{\textbf{4.64e-09}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\

 & Chr2:131,094,250-131,094,750 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.00}}} & \cellcolor[HTML]{838079}{\textcolor{white}{\textbf{1.12e-07}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\

\multirow{-3}{*}{\raggedright\arraybackslash tRNA-Glu-TTC-1-1} & Chr2:131,094,750-131,095,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.00}}} & \cellcolor[HTML]{948E78}{\textcolor{white}{\textbf{3.28e-07}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
tRNA-His-GTG-1-2 & Chr1:146,544,500-146,545,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.92}}} & \cellcolor[HTML]{ACA174}{\textcolor{white}{\textbf{1.38e-06}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
 & Chr1:149,155,750-149,156,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.05}}} & \cellcolor[HTML]{707173}{\textcolor{white}{\textbf{2.98e-08}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-His-GTG-2-1} & Chr1:149,155,500-149,156,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.83}}} & \cellcolor[HTML]{D3C164}{\textcolor{white}{\textbf{1.37e-05}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
 & Chr6: 27,251,500- 27,252,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.07}}} & \cellcolor[HTML]{656870}{\textcolor{white}{\textbf{1.45e-08}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.30}}} & \cellcolor[HTML]{002E6F}{\textcolor{white}{\textbf{1.22e-03}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-Ile-AAT-10-1} & Chr6: 27,251,750- 27,252,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.90}}} & \cellcolor[HTML]{B1A573}{\textcolor{white}{\textbf{1.86e-06}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.30}}} & \cellcolor[HTML]{002E6F}{\textcolor{white}{\textbf{1.22e-03}}}\\
\cmidrule{1-8}
 & Chr17:  8,130,000-  8,130,500 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.19}}} & \cellcolor[HTML]{1A3B6D}{\textcolor{white}{\textbf{2.98e-10}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{19.63}}} & \cellcolor[HTML]{002C6A}{\textcolor{white}{\textbf{8.92e-06}}} & \cellcolor[HTML]{d1e5f0}{\textcolor{black}{\textbf{-0.74}}} & \cellcolor[HTML]{00204D}{\textcolor{white}{\textbf{6.88e-04}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-Ile-AAT-4-1} & Chr17:  8,130,250-  8,130,750 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.77}}} & \cellcolor[HTML]{E7D159}{\textcolor{white}{\textbf{3.99e-05}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{19.63}}} & \cellcolor[HTML]{002C6A}{\textcolor{white}{\textbf{8.92e-06}}} & \cellcolor[HTML]{d1e5f0}{\textcolor{black}{\textbf{-0.74}}} & \cellcolor[HTML]{00204D}{\textcolor{white}{\textbf{6.88e-04}}}\\
\cmidrule{1-8}
tRNA-Ile-TAT-2-2 & Chr6: 26,987,750- 26,988,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.97}}} & \cellcolor[HTML]{A19976}{\textcolor{white}{\textbf{7.25e-07}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{4.16}}} & \cellcolor[HTML]{E7D159}{\textcolor{white}{\textbf{1.17e-02}}} & \cellcolor[HTML]{d1e5f0}{\textcolor{black}{\textbf{-0.60}}} & \cellcolor[HTML]{D8C563}{\textcolor{white}{\textbf{3.84e-01}}}\\
\cmidrule{1-8}
 & Chr6: 26,330,500- 26,331,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.28}}} & \cellcolor[HTML]{00204D}{\textcolor{white}{\textbf{2.83e-11}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{13.01}}} & \cellcolor[HTML]{002456}{\textcolor{white}{\textbf{6.07e-06}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{4.54}}} & \cellcolor[HTML]{002860}{\textcolor{white}{\textbf{9.35e-04}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-iMet-CAT-1-4} & Chr6: 26,330,250- 26,330,750 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.13}}} & \cellcolor[HTML]{4D556C}{\textcolor{white}{\textbf{2.89e-09}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{13.01}}} & \cellcolor[HTML]{002456}{\textcolor{white}{\textbf{6.07e-06}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{4.54}}} & \cellcolor[HTML]{002860}{\textcolor{white}{\textbf{9.35e-04}}}\\
\cmidrule{1-8}
 & Chr14: 21,093,250- 21,093,750 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.04}}} & \cellcolor[HTML]{807E79}{\textcolor{white}{\textbf{9.38e-08}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{2.49}}} & \cellcolor[HTML]{595E6D}{\textcolor{white}{\textbf{8.77e-03}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-Leu-TAG-2-1} & Chr14: 21,093,500- 21,094,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.94}}} & \cellcolor[HTML]{A39A76}{\textcolor{white}{\textbf{8.50e-07}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{2.49}}} & \cellcolor[HTML]{595E6D}{\textcolor{white}{\textbf{8.77e-03}}}\\
\cmidrule{1-8}
 & Chr6: 26,555,500- 26,556,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.04}}} & \cellcolor[HTML]{747475}{\textcolor{white}{\textbf{3.97e-08}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-Pro-AGG-2-2} & Chr6: 26,555,250- 26,555,750 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.01}}} & \cellcolor[HTML]{807E79}{\textcolor{white}{\textbf{9.58e-08}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
tRNA-Ser-ACT-1-1 & Chr6: 27,261,250- 27,261,750 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.97}}} & \cellcolor[HTML]{958F78}{\textcolor{white}{\textbf{3.53e-07}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.66}}} & \cellcolor[HTML]{B4A872}{\textcolor{white}{\textbf{1.45e-01}}}\\
\cmidrule{1-8}
 & Chr17:  8,129,750-  8,130,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.21}}} & \cellcolor[HTML]{002F6F}{\textcolor{white}{\textbf{1.16e-10}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{20.87}}} & \cellcolor[HTML]{4E576C}{\textcolor{white}{\textbf{6.72e-05}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.62}}} & \cellcolor[HTML]{898679}{\textcolor{white}{\textbf{4.28e-02}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-Ser-AGA-2-6} & Chr17:  8,130,000-  8,130,500 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.19}}} & \cellcolor[HTML]{1C3B6D}{\textcolor{white}{\textbf{3.03e-10}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{20.87}}} & \cellcolor[HTML]{4E576C}{\textcolor{white}{\textbf{6.72e-05}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.62}}} & \cellcolor[HTML]{898679}{\textcolor{white}{\textbf{4.28e-02}}}\\
\cmidrule{1-8}
tRNA-Ser-TGA-2-1 & Chr6: 27,513,000- 27,513,500 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.90}}} & \cellcolor[HTML]{BCAF6F}{\textcolor{white}{\textbf{3.58e-06}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{87.21}}} & \cellcolor[HTML]{63666F}{\textcolor{white}{\textbf{1.38e-04}}} & \cellcolor[HTML]{d1e5f0}{\textcolor{black}{\textbf{-0.25}}} & \cellcolor[HTML]{E7D159}{\textcolor{white}{\textbf{5.74e-01}}}\\
\cmidrule{1-8}
tRNA-Val-AAC-1-2 & Chr5:180,590,750-180,591,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.91}}} & \cellcolor[HTML]{BAAD70}{\textcolor{white}{\textbf{3.28e-06}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
 & Chr6: 27,648,500- 27,649,000 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{1.07}}} & \cellcolor[HTML]{64666F}{\textcolor{white}{\textbf{1.25e-08}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{40.06}}} & \cellcolor[HTML]{E2CD5C}{\textcolor{white}{\textbf{9.90e-03}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\

\multirow{-2}{*}{\raggedright\arraybackslash tRNA-Val-AAC-4-1} & Chr6: 27,648,750- 27,649,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.95}}} & \cellcolor[HTML]{989278}{\textcolor{white}{\textbf{4.31e-07}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{40.06}}} & \cellcolor[HTML]{E2CD5C}{\textcolor{white}{\textbf{9.90e-03}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\cmidrule{1-8}
tRNA-Val-CAC-2-1 & Chr6: 27,247,750- 27,248,250 & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{0.85}}} & \cellcolor[HTML]{DDC95F}{\textcolor{white}{\textbf{2.33e-05}}} & \cellcolor[HTML]{fddbc7}{\textcolor{black}{\textbf{59.16}}} & \cellcolor[HTML]{00204D}{\textcolor{white}{\textbf{5.05e-06}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}} & \cellcolor[HTML]{BBBBBB}{\textcolor[HTML]{BBBBBB}{\textbf{NA}}}\\
\bottomrule
\end{tabular}}
\end{table}
...
A full table with model results for all fitted models and all tRNA genes is provided in \protect\hyperlink{apptRNAmods}{appendix} \ref{apptRNAmods}.
...
Whilst ageing changes are pervasive throughout the DNA methylome, a strong enrichment for such changes occurs within the discrete tRNAome (Fisher's Exact Test p = \(1.05\times10^{-27}\)) (see Figure \ref{fig:sizePropEnrich} \& \protect\hyperlink{apptRNAprop}{appendix} \ref{apptRNAprop}).
...
This targeted BiS-seq was performed in blood-derived DNA from 8 pools of age-matched individuals at 4 time-points (\textasciitilde4, \textasciitilde28, \textasciitilde63, \textasciitilde78 years) from a total of 190 individuals, as detailed in Table \ref{tab:poolSummaryTable}.
...
\caption{Mean chronological age is tightly correlated with DNAm Horvath clock {[}\protect\hyperlink{ref-Horvath2013}{168}{]} predicted age for the 8 pooled samples. (See Table \ref{tab:poolSummaryTable} for pool details).}\label{fig:DNAmAgeVsChronAge}
\end{figure}
...
\caption{\label{tab:pairwiseTab}Pairwise Differences in Methylation between Age groups by tRNA. p-values are for pairwise methylation differences (see \protect\hyperlink{targetedBiSseq}{Methods} \ref{targetedBiSseq}){[}\protect\hyperlink{ref-Muller2019}{366}{]}.}
\centering
...
Full model results for the Twins UK 450k array data are provided in \protect\hyperlink{apptwins450ktRNA}{appendix} \ref{apptwins450ktRNA}.
...
tRNAs have exhibited tissue-specific expression {[}\protect\hyperlink{ref-Schmitt2014b}{378},\protect\hyperlink{ref-Dittmar2006}{325},\protect\hyperlink{ref-Sagi2016}{326}{]} and blood cell-type populations change with age.
...
Some tRNA gene expression has been shown to be highly tissue specific {[}\protect\hyperlink{ref-Schmitt2014b}{378},\protect\hyperlink{ref-Dittmar2006}{325},\protect\hyperlink{ref-Sagi2016}{326}{]}.
...
These three are tRNA-Asp-GTC-1-12, tRNA-Ile-AAT-1-4, tRNA-Glu-TTC-1-3 (Figure \ref{fig:mouse}). Full Age model Results are available in \protect\hyperlink{apptRNAmouse}{appendix} \ref{apptRNAmouse}.
...
Isodecoders expand in number with organismal complexity and the high prevalence in mammals has been suggested to be due to their additional regulatory functionality {[}\protect\hyperlink{ref-Goodenbour2006}{385},\protect\hyperlink{ref-Keam2014}{334}{]}.
...
Interestingly, tRNA gene loci may also play a role in local as well as large scale genome organisation {[}Hamdani2019; {[}\protect\hyperlink{ref-VanBortle2017}{354}{]}{]}.
tRNA gene clusters act as insulators {[}\protect\hyperlink{ref-Raab2011}{353}{]} and have extensive long-range chromatin interactions with other tRNA gene loci {[}\protect\hyperlink{ref-VanBortle2017}{354}{]}.
...
DNA methylation levels at transcription factor binding sites (TFBS) modulate the binding affinity of transcription factors for these sites {[}\protect\hyperlink{ref-Blattler2014}{425},\protect\hyperlink{ref-Yin2017}{88}{]}.
Thus deterioration in the effectiveness of the repression of Alu elements has the potential to disruptively expose this latent regulatory function {[}\protect\hyperlink{ref-Ward2013}{426},\protect\hyperlink{ref-Chuong2017}{290},\protect\hyperlink{ref-Xie2013}{427},\protect\hyperlink{ref-Zhang2019}{428}{]}.
...
Whilst DNA hypermethylation and hypomethylation are driven by distinct mechanisms {[}\protect\hyperlink{ref-Mozhui2017}{435},\protect\hyperlink{ref-Wu2017}{101}{]} CpGs undergoing these processes are approximately equally represented in DNA methylation clocks.
...
CMSA generates model coefficient by averaging across coefficients generated by cross-validation {[}\protect\hyperlink{ref-Prive2019}{438},\protect\hyperlink{ref-Friedman2010}{169},\protect\hyperlink{ref-Tibshirani2012}{441}{]}.
Details of the training and replication set to which elastic net regression was applied are detailed in \protect\hyperlink{sampleSelection}{Sample Selection} \ref{sampleSelection}.

\hypertarget{sampleSelection}{%
\subsection{Sample Selection}\label{sampleSelection}}
...
Whilst Human epigenetic age is logarithmic with time across the lifespan the effects of this are more relevant at younger ages {[}\protect\hyperlink{ref-Snir2019}{442}{]}.
...
This minimises the number of reads with the potential to misalign to other Alu elements, reads which, in this context, could lead to reduced accuracy of positionally specific Alu DNA methylation estimates {[}\protect\hyperlink{ref-Hellen2013}{443}{]}.
...
Binarisation of gene expression data yielded increased predictive accuracy in gene expression based ageing clocks {[}\protect\hyperlink{ref-Meyer2020}{444}{]}.
...
Genotype data was generated with a combination of Illumina HumanHap300 and HumanHap610Q chips {[}\protect\hyperlink{ref-Hysi2010}{445}{]}.
...
Pre-phasing was performed using Eagle v2.4 {[}\protect\hyperlink{ref-Loh2016}{446}{]}, and imputation was performed using Minimach 3.0 {[}\protect\hyperlink{ref-Das2016}{447}{]}, using haplotype information from the HRC r1.1 2016 reference panel {[}\protect\hyperlink{ref-McCarthy2017}{448}{]}.
Linear mixed models were fitted to test for associations between the phenotypes and genetic variants using GEMMA v0.94 {[}\protect\hyperlink{ref-Zhou2012a}{449}{]}.
...
Table \ref{tab:modelSummaryTabsMain} summarises the details of Alu clocks trained with the various pre-filtering criteria applied to their starting sets.
...
\caption{\label{tab:modelSummaryTabsMain}\textbf{Alu Clock Model Summaries} \emph{A)} Models fitted with Training 1 set predicting Replication 1 ages. \emph{B)} Models fitted with Training 2 set predicting Replication 2 ages. R is Pearson's correlation coefficient. RMSE = root mean squared Error, MAE = median absolute error. `+' signifies this filter is in addition to element length \textgreater180bp and 99.9\% non-zero RPM values at this locus.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{>{}lllllrrlllllrllllll}
\toprule
\textbf{ } & \textbf{Training Set} & \textbf{Prediction Set} & \textbf{R} & \textbf{R²} & \textbf{RMSE} & \textbf{MAE} & \textbf{Avail. Windows} & \textbf{Clock Windows} & \textbf{Avail. Alu Elems.} & \textbf{Clock Alu Elems.} & \textbf{Description} & \textbf{\% Coef. -ve} & \textbf{AluJ} & \textbf{AluS} & \textbf{AluY} & \textbf{FAM} & \textbf{FLAM} & \textbf{FRAM}\\
\midrule
 &  &  & \cellcolor[HTML]{FCCE25}{\textcolor{white}{\textbf{0.651}}} & \cellcolor[HTML]{FCCE25}{\textcolor{white}{\textbf{0.424}}} & 10.958 & 8.112 & 2,656,388 & 6,942 & 1,056,610 & 6,513 & No Filters & 46.744 & \cellcolor[HTML]{4daf4a}{\textbf{24.3}} & \cellcolor[HTML]{377eb8}{\textbf{59.4}} & \cellcolor[HTML]{e41a1c}{\textbf{13}} & \cellcolor[HTML]{984ea3}{\textbf{0.389}} & \cellcolor[HTML]{ff7f00}{\textbf{2.39}} & \cellcolor[HTML]{ffff33}{\textbf{0.533}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{FDAE32}{\textcolor{white}{\textbf{0.619}}} & \cellcolor[HTML]{FCA238}{\textcolor{white}{\textbf{0.383}}} & 11.201 & 8.349 & 1,858,147 & 6,616 & 788,953 & 6,196 & >180bp, 99.9\% non-zero & 47.415 & \cellcolor[HTML]{4daf4a}{\textbf{25.4}} & \cellcolor[HTML]{377eb8}{\textbf{59.9}} & \cellcolor[HTML]{e41a1c}{\textbf{11.9}} & \cellcolor[HTML]{984ea3}{\textbf{0.378}} & \cellcolor[HTML]{ff7f00}{\textbf{1.96}} & \cellcolor[HTML]{ffff33}{\textbf{0.514}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{FCA438}{\textcolor{white}{\textbf{0.609}}} & \cellcolor[HTML]{F9983E}{\textcolor{white}{\textbf{0.371}}} & 11.165 & 8.221 & 981,452 & 6,293 & 561,509 & 5,894 & + CpG Density >2\% & 47.624 & \cellcolor[HTML]{4daf4a}{\textbf{26.1}} & \cellcolor[HTML]{377eb8}{\textbf{58.5}} & \cellcolor[HTML]{e41a1c}{\textbf{12}} & \cellcolor[HTML]{984ea3}{\textbf{0.493}} & \cellcolor[HTML]{ff7f00}{\textbf{2.38}} & \cellcolor[HTML]{ffff33}{\textbf{0.556}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F89441}{\textcolor{white}{\textbf{0.591}}} & \cellcolor[HTML]{F2844B}{\textcolor{white}{\textbf{0.349}}} & 11.243 & 8.360 & 1,858,147 & 2,131 & 788,953 & 2,066 & + ln(Age) & 46.739 & \cellcolor[HTML]{4daf4a}{\textbf{25.5}} & \cellcolor[HTML]{377eb8}{\textbf{59}} & \cellcolor[HTML]{e41a1c}{\textbf{12.6}} & \cellcolor[HTML]{984ea3}{\textbf{0.235}} & \cellcolor[HTML]{ff7f00}{\textbf{2.21}} & \cellcolor[HTML]{ffff33}{\textbf{0.516}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F0804F}{\textcolor{white}{\textbf{0.566}}} & \cellcolor[HTML]{E56B5D}{\textcolor{white}{\textbf{0.321}}} & 11.275 & 8.010 & 6,000 & 1,269 & 5,283 & 1,040 & + Consistent Direction & 47.518 & \cellcolor[HTML]{4daf4a}{\textbf{21}} & \cellcolor[HTML]{377eb8}{\textbf{60.5}} & \cellcolor[HTML]{e41a1c}{\textbf{14.7}} & \cellcolor[HTML]{984ea3}{\textbf{0.394}} & \cellcolor[HTML]{ff7f00}{\textbf{2.76}} & \cellcolor[HTML]{ffff33}{\textbf{0.63}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{DE5E65}{\textcolor{white}{\textbf{0.524}}} & \cellcolor[HTML]{CC4877}{\textcolor{white}{\textbf{0.275}}} & 11.542 & 8.541 & 192,299 & 4,884 & 138,506 & 4,573 & + CpG Density >5\% & 48.464 & \cellcolor[HTML]{4daf4a}{\textbf{26.4}} & \cellcolor[HTML]{377eb8}{\textbf{57}} & \cellcolor[HTML]{e41a1c}{\textbf{12.8}} & \cellcolor[HTML]{984ea3}{\textbf{0.389}} & \cellcolor[HTML]{ff7f00}{\textbf{2.78}} & \cellcolor[HTML]{ffff33}{\textbf{0.696}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{A21D9A}{\textcolor{white}{\textbf{0.432}}} & \cellcolor[HTML]{8606A6}{\textcolor{white}{\textbf{0.186}}} & 12.152 & 9.006 & 4,289 & 1,187 & 3,708 & 924 & + Hypomethylation & 56.613 & \cellcolor[HTML]{4daf4a}{\textbf{21.3}} & \cellcolor[HTML]{377eb8}{\textbf{59.2}} & \cellcolor[HTML]{e41a1c}{\textbf{15.2}} & \cellcolor[HTML]{984ea3}{\textbf{0.337}} & \cellcolor[HTML]{ff7f00}{\textbf{2.95}} & \cellcolor[HTML]{ffff33}{\textbf{0.927}}\\
\cmidrule{4-19}
\multirow[t]{-8}{*}{\raggedright\arraybackslash \textbf{A}} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Training 1} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Replication 1} & \cellcolor[HTML]{100788}{\textcolor{white}{\textbf{0.292}}} & \cellcolor[HTML]{100788}{\textcolor{white}{\textbf{0.085}}} & 12.879 & 9.614 & 92,473 & 1,880 & 62,731 & 1,769 & + Only AluY Elems. & 51.330 & \cellcolor[HTML]{4daf4a}{\textbf{26.1}} & \cellcolor[HTML]{377eb8}{\textbf{57.2}} & \cellcolor[HTML]{e41a1c}{\textbf{12.4}} & \cellcolor[HTML]{984ea3}{\textbf{0.479}} & \cellcolor[HTML]{ff7f00}{\textbf{3.09}} & \cellcolor[HTML]{ffff33}{\textbf{0.638}}\\
\cmidrule{1-19}
 &  &  & \cellcolor[HTML]{FCA934}{\textcolor{white}{\textbf{0.615}}} & \cellcolor[HTML]{FA9E3B}{\textcolor{white}{\textbf{0.378}}} & 12.021 & 8.753 & 2,656,388 & 7,091 & 1,056,610 & 6,610 & No Filters & 46.002 & \cellcolor[HTML]{4daf4a}{\textbf{25.3}} & \cellcolor[HTML]{377eb8}{\textbf{59.2}} & \cellcolor[HTML]{e41a1c}{\textbf{12.4}} & \cellcolor[HTML]{984ea3}{\textbf{0.268}} & \cellcolor[HTML]{ff7f00}{\textbf{2.31}} & \cellcolor[HTML]{ffff33}{\textbf{0.522}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F58C46}{\textcolor{white}{\textbf{0.582}}} & \cellcolor[HTML]{EE7B51}{\textcolor{white}{\textbf{0.339}}} & 11.828 & 8.442 & 192,299 & 5,007 & 138,506 & 4,650 & + CpG Density >5\% & 48.252 & \cellcolor[HTML]{4daf4a}{\textbf{26}} & \cellcolor[HTML]{377eb8}{\textbf{58.5}} & \cellcolor[HTML]{e41a1c}{\textbf{12}} & \cellcolor[HTML]{984ea3}{\textbf{0.499}} & \cellcolor[HTML]{ff7f00}{\textbf{2.52}} & \cellcolor[HTML]{ffff33}{\textbf{0.519}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F48849}{\textcolor{white}{\textbf{0.576}}} & \cellcolor[HTML]{EB7556}{\textcolor{white}{\textbf{0.332}}} & 12.332 & 8.908 & 1,858,147 & 6,435 & 788,953 & 6,021 & >180bp, 99.9\% non-zero & 46.636 & \cellcolor[HTML]{4daf4a}{\textbf{24.6}} & \cellcolor[HTML]{377eb8}{\textbf{59.3}} & \cellcolor[HTML]{e41a1c}{\textbf{12.6}} & \cellcolor[HTML]{984ea3}{\textbf{0.389}} & \cellcolor[HTML]{ff7f00}{\textbf{2.69}} & \cellcolor[HTML]{ffff33}{\textbf{0.451}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F2844B}{\textcolor{white}{\textbf{0.572}}} & \cellcolor[HTML]{E97257}{\textcolor{white}{\textbf{0.328}}} & 11.844 & 8.928 & 1,858,147 & 2,621 & 788,953 & 2,546 & + ln(Age) & 44.830 & \cellcolor[HTML]{4daf4a}{\textbf{23.9}} & \cellcolor[HTML]{377eb8}{\textbf{60.5}} & \cellcolor[HTML]{e41a1c}{\textbf{12.2}} & \cellcolor[HTML]{984ea3}{\textbf{0.496}} & \cellcolor[HTML]{ff7f00}{\textbf{2.29}} & \cellcolor[HTML]{ffff33}{\textbf{0.534}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F2844B}{\textcolor{white}{\textbf{0.572}}} & \cellcolor[HTML]{E97257}{\textcolor{white}{\textbf{0.328}}} & 12.296 & 8.560 & 981,452 & 5,518 & 561,509 & 5,200 & + CpG Density >2\% & 47.191 & \cellcolor[HTML]{4daf4a}{\textbf{26}} & \cellcolor[HTML]{377eb8}{\textbf{57.9}} & \cellcolor[HTML]{e41a1c}{\textbf{12.4}} & \cellcolor[HTML]{984ea3}{\textbf{0.217}} & \cellcolor[HTML]{ff7f00}{\textbf{3.03}} & \cellcolor[HTML]{ffff33}{\textbf{0.544}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{DC5D67}{\textcolor{white}{\textbf{0.520}}} & \cellcolor[HTML]{CA457A}{\textcolor{white}{\textbf{0.271}}} & 12.249 & 8.186 & 6,000 & 1,238 & 5,283 & 1,026 & + Consistent Direction & 48.142 & \cellcolor[HTML]{4daf4a}{\textbf{22.3}} & \cellcolor[HTML]{377eb8}{\textbf{58.6}} & \cellcolor[HTML]{e41a1c}{\textbf{15.7}} & \cellcolor[HTML]{984ea3}{\textbf{0.162}} & \cellcolor[HTML]{ff7f00}{\textbf{2.58}} & \cellcolor[HTML]{ffff33}{\textbf{0.727}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{8A09A5}{\textcolor{white}{\textbf{0.404}}} & \cellcolor[HTML]{6E00A8}{\textcolor{white}{\textbf{0.163}}} & 12.953 & 9.330 & 4,289 & 1,045 & 3,708 & 853 & + Hypomethylation & 58.086 & \cellcolor[HTML]{4daf4a}{\textbf{22.4}} & \cellcolor[HTML]{377eb8}{\textbf{56.1}} & \cellcolor[HTML]{e41a1c}{\textbf{17.6}} & \cellcolor[HTML]{984ea3}{\textbf{0.191}} & \cellcolor[HTML]{ff7f00}{\textbf{3.16}} & \cellcolor[HTML]{ffff33}{\textbf{0.574}}\\
\cmidrule{4-19}
\multirow[t]{-8}{*}{\raggedright\arraybackslash \textbf{B}} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Training 2} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Replication 2} & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.290}}} & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.084}}} & 13.657 & 9.459 & 92,473 & 2,656 & 62,731 & 2,478 & + Only AluY Elems. & 50.075 & \cellcolor[HTML]{4daf4a}{\textbf{26}} & \cellcolor[HTML]{377eb8}{\textbf{59.2}} & \cellcolor[HTML]{e41a1c}{\textbf{11.3}} & \cellcolor[HTML]{984ea3}{\textbf{0.301}} & \cellcolor[HTML]{ff7f00}{\textbf{2.52}} & \cellcolor[HTML]{ffff33}{\textbf{0.678}}\\
\bottomrule
\end{tabular}}
\end{table}
...
Table \ref{tab:modelSummaryTabsCtrl} shows the model summaries when correlations are computed for for the related sets comprised of the twins of individuals in the training set.
...
\caption{\label{tab:modelSummaryTabsCtrl}\textbf{Summaries of Alu Clock Models Predicting Twin Groups} for the purpose of comparing predictive of age models in related and unrelated samples. \emph{A)} Models fitted with Training 1 set predicting Replication 2 ages. \emph{B)} Models fitted with Training 2 set predicting Replication 1 ages. R is Pearson's correlation coefficient. RMSE = root mean squared Error, MAE = median absolute error. `+' signifies this filter is in addition to element length \textgreater180bp and 99.9\% non-zero RPM values at this locus.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{>{}lllllrrlllllrllllll}
...
\textbf{ } & \textbf{Training Set} & \textbf{Prediction Set} & \textbf{R} & \textbf{R²} & \textbf{RMSE} & \textbf{MAE} & \textbf{Avail. Windows} & \textbf{Clock Windows} & \textbf{Avail. Alu Elems.} & \textbf{Clock Alu Elems.} & \textbf{Description} & \textbf{\% Coef. -ve} & \textbf{AluJ} & \textbf{AluS} & \textbf{AluY} & \textbf{FAM} & \textbf{FLAM} & \textbf{FRAM}\\
\midrule
 &  &  & \cellcolor[HTML]{FCCE25}{\textcolor{white}{\textbf{0.677}}} & \cellcolor[HTML]{FCCE25}{\textcolor{white}{\textbf{0.458}}} & 11.380 & 8.191 & 2,656,388 & 6,311 & 1,056,610 & 5,930 & No Filters & 46.427 & \cellcolor[HTML]{4daf4a}{\textbf{24.7}} & \cellcolor[HTML]{377eb8}{\textbf{59.8}} & \cellcolor[HTML]{e41a1c}{\textbf{12.3}} & \cellcolor[HTML]{984ea3}{\textbf{0.38}} & \cellcolor[HTML]{ff7f00}{\textbf{2.33}} & \cellcolor[HTML]{ffff33}{\textbf{0.475}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{FDAF31}{\textcolor{white}{\textbf{0.644}}} & \cellcolor[HTML]{FCA438}{\textcolor{white}{\textbf{0.415}}} & 11.626 & 8.388 & 1,858,147 & 6,327 & 788,953 & 5,948 & >180bp, 99.9\% non-zero & 47.432 & \cellcolor[HTML]{4daf4a}{\textbf{25.1}} & \cellcolor[HTML]{377eb8}{\textbf{60.2}} & \cellcolor[HTML]{e41a1c}{\textbf{11.6}} & \cellcolor[HTML]{984ea3}{\textbf{0.253}} & \cellcolor[HTML]{ff7f00}{\textbf{2.29}} & \cellcolor[HTML]{ffff33}{\textbf{0.616}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{FBA238}{\textcolor{white}{\textbf{0.631}}} & \cellcolor[HTML]{F89540}{\textcolor{white}{\textbf{0.398}}} & 11.600 & 8.240 & 981,452 & 6,610 & 561,509 & 6,215 & + CpG Density >2\% & 47.428 & \cellcolor[HTML]{4daf4a}{\textbf{26.3}} & \cellcolor[HTML]{377eb8}{\textbf{58.7}} & \cellcolor[HTML]{e41a1c}{\textbf{11.8}} & \cellcolor[HTML]{984ea3}{\textbf{0.424}} & \cellcolor[HTML]{ff7f00}{\textbf{2.34}} & \cellcolor[HTML]{ffff33}{\textbf{0.454}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{F48849}{\textcolor{white}{\textbf{0.600}}} & \cellcolor[HTML]{EB7556}{\textcolor{white}{\textbf{0.360}}} & 11.593 & 7.908 & 192,299 & 5,052 & 138,506 & 4,707 & + CpG Density >5\% & 48.733 & \cellcolor[HTML]{4daf4a}{\textbf{25.9}} & \cellcolor[HTML]{377eb8}{\textbf{57.6}} & \cellcolor[HTML]{e41a1c}{\textbf{12.5}} & \cellcolor[HTML]{984ea3}{\textbf{0.337}} & \cellcolor[HTML]{ff7f00}{\textbf{2.99}} & \cellcolor[HTML]{ffff33}{\textbf{0.673}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{EB7557}{\textcolor{white}{\textbf{0.575}}} & \cellcolor[HTML]{DE6065}{\textcolor{white}{\textbf{0.330}}} & 11.854 & 8.313 & 6,000 & 1,208 & 5,283 & 1,005 & + Consistent Direction & 48.427 & \cellcolor[HTML]{4daf4a}{\textbf{20.9}} & \cellcolor[HTML]{377eb8}{\textbf{61.3}} & \cellcolor[HTML]{e41a1c}{\textbf{14.4}} & \cellcolor[HTML]{984ea3}{\textbf{0.248}} & \cellcolor[HTML]{ff7f00}{\textbf{2.73}} & \cellcolor[HTML]{ffff33}{\textbf{0.331}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{E87059}{\textcolor{white}{\textbf{0.569}}} & \cellcolor[HTML]{DA5B69}{\textcolor{white}{\textbf{0.324}}} & 11.710 & 8.531 & 1,858,147 & 2,401 & 788,953 & 2,334 & + ln(Age) & 46.397 & \cellcolor[HTML]{4daf4a}{\textbf{24.5}} & \cellcolor[HTML]{377eb8}{\textbf{59.8}} & \cellcolor[HTML]{e41a1c}{\textbf{12.3}} & \cellcolor[HTML]{984ea3}{\textbf{0.25}} & \cellcolor[HTML]{ff7f00}{\textbf{2.54}} & \cellcolor[HTML]{ffff33}{\textbf{0.583}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{C03A83}{\textcolor{white}{\textbf{0.492}}} & \cellcolor[HTML]{A72196}{\textcolor{white}{\textbf{0.242}}} & 12.359 & 9.165 & 4,289 & 1,297 & 3,708 & 1,002 & + Hypomethylation & 54.819 & \cellcolor[HTML]{4daf4a}{\textbf{21.7}} & \cellcolor[HTML]{377eb8}{\textbf{59.8}} & \cellcolor[HTML]{e41a1c}{\textbf{14.9}} & \cellcolor[HTML]{984ea3}{\textbf{0.463}} & \cellcolor[HTML]{ff7f00}{\textbf{2.47}} & \cellcolor[HTML]{ffff33}{\textbf{0.694}}\\
\cmidrule{4-19}
\multirow[t]{-8}{*}{\raggedright\arraybackslash \textbf{A}} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Training 1} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Replication 2} & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.302}}} & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.091}}} & 13.450 & 9.342 & 92,473 & 1,951 & 62,731 & 1,839 & + Only AluY Elems. & 51.205 & \cellcolor[HTML]{4daf4a}{\textbf{25.1}} & \cellcolor[HTML]{377eb8}{\textbf{59}} & \cellcolor[HTML]{e41a1c}{\textbf{11.8}} & \cellcolor[HTML]{984ea3}{\textbf{0.564}} & \cellcolor[HTML]{ff7f00}{\textbf{2.97}} & \cellcolor[HTML]{ffff33}{\textbf{0.615}}\\
\cmidrule{1-19}
 &  &  & \cellcolor[HTML]{FCA537}{\textcolor{white}{\textbf{0.634}}} & \cellcolor[HTML]{F9993E}{\textcolor{white}{\textbf{0.402}}} & 11.171 & 8.047 & 2,656,388 & 6,857 & 1,056,610 & 6,406 & No Filters & 45.909 & \cellcolor[HTML]{4daf4a}{\textbf{25.3}} & \cellcolor[HTML]{377eb8}{\textbf{59.6}} & \cellcolor[HTML]{e41a1c}{\textbf{12}} & \cellcolor[HTML]{984ea3}{\textbf{0.335}} & \cellcolor[HTML]{ff7f00}{\textbf{2.06}} & \cellcolor[HTML]{ffff33}{\textbf{0.613}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{EF7D50}{\textcolor{white}{\textbf{0.586}}} & \cellcolor[HTML]{E5695D}{\textcolor{white}{\textbf{0.343}}} & 11.245 & 8.216 & 1,858,147 & 2,052 & 788,953 & 1,986 & + ln(Age) & 43.275 & \cellcolor[HTML]{4daf4a}{\textbf{23.6}} & \cellcolor[HTML]{377eb8}{\textbf{61.6}} & \cellcolor[HTML]{e41a1c}{\textbf{12}} & \cellcolor[HTML]{984ea3}{\textbf{0.439}} & \cellcolor[HTML]{ff7f00}{\textbf{1.8}} & \cellcolor[HTML]{ffff33}{\textbf{0.439}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{EE7B51}{\textcolor{white}{\textbf{0.582}}} & \cellcolor[HTML]{E26660}{\textcolor{white}{\textbf{0.339}}} & 11.591 & 8.631 & 981,452 & 5,226 & 561,509 & 4,893 & + CpG Density >2\% & 47.608 & \cellcolor[HTML]{4daf4a}{\textbf{25.9}} & \cellcolor[HTML]{377eb8}{\textbf{57.7}} & \cellcolor[HTML]{e41a1c}{\textbf{12.3}} & \cellcolor[HTML]{984ea3}{\textbf{0.402}} & \cellcolor[HTML]{ff7f00}{\textbf{3.12}} & \cellcolor[HTML]{ffff33}{\textbf{0.574}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{E97357}{\textcolor{white}{\textbf{0.573}}} & \cellcolor[HTML]{DE5E65}{\textcolor{white}{\textbf{0.328}}} & 11.624 & 8.658 & 1,858,147 & 5,907 & 788,953 & 5,545 & >180bp, 99.9\% non-zero & 46.843 & \cellcolor[HTML]{4daf4a}{\textbf{25.3}} & \cellcolor[HTML]{377eb8}{\textbf{58.2}} & \cellcolor[HTML]{e41a1c}{\textbf{13}} & \cellcolor[HTML]{984ea3}{\textbf{0.423}} & \cellcolor[HTML]{ff7f00}{\textbf{2.57}} & \cellcolor[HTML]{ffff33}{\textbf{0.542}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{E87059}{\textcolor{white}{\textbf{0.568}}} & \cellcolor[HTML]{DA5B69}{\textcolor{white}{\textbf{0.323}}} & 11.242 & 8.038 & 192,299 & 4,821 & 138,506 & 4,449 & + CpG Density >5\% & 47.832 & \cellcolor[HTML]{4daf4a}{\textbf{26.1}} & \cellcolor[HTML]{377eb8}{\textbf{57.7}} & \cellcolor[HTML]{e41a1c}{\textbf{12.6}} & \cellcolor[HTML]{984ea3}{\textbf{0.436}} & \cellcolor[HTML]{ff7f00}{\textbf{2.47}} & \cellcolor[HTML]{ffff33}{\textbf{0.622}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{CD4A76}{\textcolor{white}{\textbf{0.513}}} & \cellcolor[HTML]{B6308B}{\textcolor{white}{\textbf{0.263}}} & 11.675 & 8.438 & 6,000 & 933 & 5,283 & 815 & + Consistent Direction & 48.553 & \cellcolor[HTML]{4daf4a}{\textbf{22.3}} & \cellcolor[HTML]{377eb8}{\textbf{59.1}} & \cellcolor[HTML]{e41a1c}{\textbf{15.3}} & \cellcolor[HTML]{984ea3}{\textbf{0.322}} & \cellcolor[HTML]{ff7f00}{\textbf{2.14}} & \cellcolor[HTML]{ffff33}{\textbf{0.857}}\\
\cmidrule{4-19}
 &  &  & \cellcolor[HTML]{7701A8}{\textcolor{white}{\textbf{0.398}}} & \cellcolor[HTML]{5C01A6}{\textcolor{white}{\textbf{0.159}}} & 12.437 & 8.769 & 92,473 & 3,158 & 62,731 & 2,947 & + Only AluY Elems. & 48.892 & \cellcolor[HTML]{4daf4a}{\textbf{26.2}} & \cellcolor[HTML]{377eb8}{\textbf{59.8}} & \cellcolor[HTML]{e41a1c}{\textbf{10.3}} & \cellcolor[HTML]{984ea3}{\textbf{0.538}} & \cellcolor[HTML]{ff7f00}{\textbf{2.47}} & \cellcolor[HTML]{ffff33}{\textbf{0.665}}\\
\cmidrule{4-19}
\multirow[t]{-8}{*}{\raggedright\arraybackslash \textbf{B}} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Training 2} & \multirow[t]{-8}{*}{\raggedright\arraybackslash Replication 1} & \cellcolor[HTML]{330597}{\textcolor{white}{\textbf{0.329}}} & \cellcolor[HTML]{280592}{\textcolor{white}{\textbf{0.108}}} & 12.619 & 8.752 & 4,289 & 752 & 3,708 & 641 & + Hypomethylation & 61.037 & \cellcolor[HTML]{4daf4a}{\textbf{23.1}} & \cellcolor[HTML]{377eb8}{\textbf{54}} & \cellcolor[HTML]{e41a1c}{\textbf{18.9}} & \cellcolor[HTML]{984ea3}{\textbf{0.266}} & \cellcolor[HTML]{ff7f00}{\textbf{2.93}} & \cellcolor[HTML]{ffff33}{\textbf{0.798}}\\
\bottomrule
\end{tabular}}
\end{table}
...
These sites are listed in \protect\hyperlink{appAluageSNPs}{appendix} \ref{appAluageSNPs} with the top 10 sites from each GWAS shown in Figures \ref{tab:m1tab} \& \ref{tab:m2tab} respectively.
...
\caption{\label{tab:m1tab}Top 10 SNPs from model 1.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
...
\midrule
Chr12: 28,247,840 & C & T & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.013}}} & rs192929352 & \cellcolor[HTML]{440154}{\textcolor{white}{\textbf{1.28e-07}}}\\
Chr12: 28,249,160 & G & A & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.013}}} & rs73080027 & \cellcolor[HTML]{440154}{\textcolor{white}{\textbf{1.29e-07}}}\\
Chr12: 28,275,831 & C & T & \cellcolor[HTML]{C33D80}{\textcolor{white}{\textbf{0.014}}} & rs12320589 & \cellcolor[HTML]{23888E}{\textcolor{white}{\textbf{5.77e-07}}}\\
Chr12: 28,275,948 & A & G & \cellcolor[HTML]{C33D80}{\textcolor{white}{\textbf{0.014}}} & rs73081931 & \cellcolor[HTML]{23888E}{\textcolor{white}{\textbf{5.78e-07}}}\\
Chr12: 28,437,969 & G & A & \cellcolor[HTML]{E56B5D}{\textcolor{white}{\textbf{0.013}}} & rs73083941 & \cellcolor[HTML]{27AD81}{\textcolor{white}{\textbf{7.3e-07}}}\\
Chr12: 78,820,816 & T & C & \cellcolor[HTML]{FDAB33}{\textcolor{white}{\textbf{0.526}}} & rs2060031 & \cellcolor[HTML]{81D34D}{\textcolor{white}{\textbf{9.1e-07}}}\\
Chr12: 28,329,758 & G & C & \cellcolor[HTML]{FEB72D}{\textcolor{white}{\textbf{0.013}}} & rs73081984 & \cellcolor[HTML]{95D840}{\textcolor{white}{\textbf{9.4e-07}}}\\
Chr12: 28,334,179 & T & G & \cellcolor[HTML]{FEB72D}{\textcolor{white}{\textbf{0.013}}} & rs115527307 & \cellcolor[HTML]{95D840}{\textcolor{white}{\textbf{9.42e-07}}}\\
Chr12: 28,319,636 & T & C & \cellcolor[HTML]{FDC627}{\textcolor{white}{\textbf{0.013}}} & rs73081974 & \cellcolor[HTML]{B0DD2F}{\textcolor{white}{\textbf{9.77e-07}}}\\
Chr12: 28,311,049 & C & T & \cellcolor[HTML]{FCCE25}{\textcolor{white}{\textbf{0.013}}} & rs115986349 & \cellcolor[HTML]{BBDF27}{\textcolor{white}{\textbf{9.95e-07}}}\\
\bottomrule
\end{tabular}}
\end{table}
...
\caption{\label{tab:m2tab}Top 10 SNPs from model 2.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{llllll}
...
locus & ref & alt & AF & SNP & p-value\\
\midrule
Chr12: 28,247,840 & C & T & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.013}}} & rs192929352 & \cellcolor[HTML]{440154}{\textcolor{white}{\textbf{6.55e-08}}}\\
Chr12: 28,249,160 & G & A & \cellcolor[HTML]{0D0887}{\textcolor{white}{\textbf{0.013}}} & rs73080027 & \cellcolor[HTML]{440154}{\textcolor{white}{\textbf{6.57e-08}}}\\
Chr12: 28,275,831 & C & T & \cellcolor[HTML]{CC4778}{\textcolor{white}{\textbf{0.014}}} & rs12320589 & \cellcolor[HTML]{21918C}{\textcolor{white}{\textbf{2.66e-07}}}\\
Chr12: 28,275,948 & A & G & \cellcolor[HTML]{CC4778}{\textcolor{white}{\textbf{0.014}}} & rs73081931 & \cellcolor[HTML]{21918C}{\textcolor{white}{\textbf{2.66e-07}}}\\
Chr12: 28,258,339 & C & T & \cellcolor[HTML]{FDC527}{\textcolor{white}{\textbf{0.016}}} & rs35792578 & \cellcolor[HTML]{ADDC30}{\textcolor{white}{\textbf{4.18e-07}}}\\
Chr12: 28,249,612 & C & T & \cellcolor[HTML]{FCCC25}{\textcolor{white}{\textbf{0.016}}} & rs11830823 & \cellcolor[HTML]{B9DE28}{\textcolor{white}{\textbf{4.25e-07}}}\\
Chr12: 28,249,623 & A & C & \cellcolor[HTML]{FCCC25}{\textcolor{white}{\textbf{0.016}}} & rs11835433 & \cellcolor[HTML]{B9DE28}{\textcolor{white}{\textbf{4.25e-07}}}\\
Chr12: 28,250,701 & C & T & \cellcolor[HTML]{FCCC25}{\textcolor{white}{\textbf{0.016}}} & rs7956083 & \cellcolor[HTML]{B9DE28}{\textcolor{white}{\textbf{4.25e-07}}}\\
Chr12: 28,250,549 & A & G & \cellcolor[HTML]{FCCC25}{\textcolor{white}{\textbf{0.016}}} & rs7955851 & \cellcolor[HTML]{B9DE28}{\textcolor{white}{\textbf{4.25e-07}}}\\
Chr12: 28,249,196 & A & G & \cellcolor[HTML]{FCCE25}{\textcolor{white}{\textbf{0.016}}} & rs11835353 & \cellcolor[HTML]{BBDF27}{\textcolor{white}{\textbf{4.26e-07}}}\\
\bottomrule
\end{tabular}}
\end{table}
...
Though this approach also has the limitation that biologically relevant effects may be realised through small perturbations across many systems {[}\protect\hyperlink{ref-Boyle2017}{466}{]}, meaning no whole network may stand out.
...
7. United Nations, Department of Economic and Social Affairs PDivision: \textbf{{PopulationPyramid.net}}. Available: \href{https://PopulationPyramid.net}{PopulationPyramid.net}.
...
92. Raiber E, Portella G, Martínez Cuesta S, Hardisty R, Murat P, Li Z, Iurlaro M, Dean W, Spindel J, Beraldi D, Liu Z, Dawson MA, Reik W, Balasubramanian S: \textbf{{5-Formylcytosine organizes nucleosomes and forms Schiff base interactions with histones in mouse embryonic stem cells}}. \emph{Nature Chemistry} 2018, \textbf{10}:1258--1266\href{https://doi.org/10.1038/s41557-018-0149-x}{10.1038/s41557-018-0149-x}Available: \url{http://www.nature.com/articles/s41557-018-0149-x}.
...
98. Tahiliani M, Koh KP, Shen Y, Pastor Wa, Bandukwala H, Brudno Y, Agarwal S, Iyer LM, Liu DR, Aravind L, Rao A: \textbf{{Conversion of 5-Methylcytosine to 5-Hydroxymethylcytosine in Mammalian DNA by MLL Partner TET1}}. \emph{Science} 2009, \textbf{324}:930--935\href{https://doi.org/10.1126/science.1170116}{10.1126/science.1170116}Available: \url{http://www.sciencemag.org/cgi/doi/10.1126/science.1170116}.
...
122. Zhao L, Sun M, Li Z, Bai X, Yu M, Wang M, Liang L, Shao X, Arnovitz S, Wang Q, He C, Lu X, Chen J, Xie H: \textbf{{The dynamics of DNA methylation fidelity during mouse embryonic stem cell self-renewal and differentiation}}. \emph{Genome Research} 2014, \textbf{24}:1296--1307\href{https://doi.org/10.1101/gr.163147.113}{10.1101/gr.163147.113}Available: \url{http://genome.cshlp.org/lookup/doi/10.1101/gr.163147.113}.
...
157. Bell CG, Teschendorff AE, Rakyan VK, Maxwell AP, Beck S, Savage Da: \textbf{{Genome-wide DNA methylation analysis for diabetic nephropathy in type 1 diabetes mellitus}}. \emph{BMC Medical Genomics} 2010, \textbf{3}:33\href{https://doi.org/10.1186/1755-8794-3-33}{10.1186/1755-8794-3-33}Available: \url{http://bmcmedgenomics.biomedcentral.com/articles/10.1186/1755-8794-3-33}.
...
178. Velten L, Haas SF, Raffel S, Blaszkiewicz S, Islam S, Hennig BP, Hirche C, Lutz C, Buss EC, Nowak D, Boch T, Hofmann W, Ho AD, Huber W, Trumpp A, Essers MAG, Steinmetz LM: \textbf{{Human haematopoietic stem cell lineage commitment is a continuous process}}. \emph{Nature Cell Biology} 2017, \textbf{19}:271--281\href{https://doi.org/10.1038/ncb3493}{10.1038/ncb3493}Available: \url{http://www.nature.com/articles/ncb3493}.
...
234. Tran H, Porter J, Sun M, Xie H, Zhang L: \textbf{{Objective and Comprehensive Evaluation of Bisulfite Short Read Mapping Tools}}. \emph{Advances in Bioinformatics} 2014, \textbf{2014}:1--11\href{https://doi.org/10.1155/2014/472045}{10.1155/2014/472045}Available: \url{http://www.hindawi.com/journals/abi/2014/472045/}.
...
355. Noma K, Cam HP, Maraia RJ, Grewal SIS: \textbf{{A role for TFIIIC transcription factor complex in genome organization.}} \emph{Cell} 2006, \textbf{125}:859--72\href{https://doi.org/10.1016/j.cell.2006.04.028}{10.1016/j.cell.2006.04.028}Available: \url{http://www.ncbi.nlm.nih.gov/pubmed/16751097}.
...
442. Snir S, Farrell C, Pellegrini M: \textbf{{Human epigenetic ageing is logarithmic with time across the entire lifespan}}. \emph{Epigenetics} 2019, \textbf{0}:1--15\href{https://doi.org/10.1080/15592294.2019.1623634}{10.1080/15592294.2019.1623634}Available: \url{https://www.tandfonline.com/doi/full/10.1080/15592294.2019.1623634}.

\leavevmode\hypertarget{ref-Hellen2013}{}%
443. Hellen EH, Brookfield JF: \textbf{{Alu elements in primates are preferentially lost from areas of high GC content}}. \emph{PeerJ} 2013, \textbf{1}:e78\href{https://doi.org/10.7717/peerj.78}{10.7717/peerj.78}Available: \url{https://peerj.com/articles/78}.

\leavevmode\hypertarget{ref-Meyer2020}{}%
444. Meyer DH: \textbf{{A transcriptome based aging clock near the theoretical limit of accuracy}}. 2020, \href{https://doi.org/10.1101/2020.05.29.123430}{10.1101/2020.05.29.123430}Available: \url{https://doi.org/10.1101/2020.05.29.123430}.

\leavevmode\hypertarget{ref-Hysi2010}{}%
445. Hysi PG, Young TL, Mackey DA, Andrew T, Fernández-Medarde A, Solouki AM, Hewitt AW, Macgregor S, Vingerling JR, Li Y, Ikram MK, Fai LY, Sham PC, Manyes L, Porteros A, Lopes MC, Carbonaro F, Fahy SJ, Martin NG, Duijn CM van, Spector TD, Rahi JS, Santos E, Klaver CCW, Hammond CJ: \textbf{{A genome-wide association study for myopia and refractive error identifies a susceptibility locus at 15q25}}. \emph{Nature Genetics} 2010, \textbf{42}:902--905\href{https://doi.org/10.1038/ng.664}{10.1038/ng.664}Available: \url{http://www.nature.com/articles/ng.664}.

\leavevmode\hypertarget{ref-Loh2016}{}%
446. Loh P, Palamara PF, Price AL: \textbf{{Fast and accurate long-range phasing in a UK Biobank cohort}}. \emph{Nature Genetics} 2016, \textbf{48}:811--816\href{https://doi.org/10.1038/ng.3571}{10.1038/ng.3571}Available: \url{http://www.nature.com/articles/ng.3571}.

\leavevmode\hypertarget{ref-Das2016}{}%
447. Das S, Forer L, Schönherr S, Sidore C, Locke AE, Kwong A, Vrieze SI, Chew EY, Levy S, McGue M, Schlessinger D, Stambolian D, Loh P-R, Iacono WG, Swaroop A, Scott LJ, Cucca F, Kronenberg F, Boehnke M, Abecasis GR, Fuchsberger C: \textbf{{Next-generation genotype imputation service and methods}}. \emph{Nature Genetics} 2016, \textbf{48}:1284--1287\href{https://doi.org/10.1038/ng.3656}{10.1038/ng.3656}Available: \url{http://www.nature.com/articles/ng.3656}.

\leavevmode\hypertarget{ref-McCarthy2017}{}%
448. McCarthy S: \textbf{{A reference panel of 64,976 haplotypes for genotype imputation}}. \emph{Nature Genetics} 2016, \textbf{48}:1279--1283\href{https://doi.org/10.1038/ng.3643}{10.1038/ng.3643}Available: \url{http://www.nature.com/articles/ng.3643}.

\leavevmode\hypertarget{ref-Zhou2012a}{}%
449. Zhou X, Stephens M: \textbf{{Genome-wide efficient mixed-model analysis for association studies}}. \emph{Nature Genetics} 2012, \textbf{44}:821--824\href{https://doi.org/10.1038/ng.2310}{10.1038/ng.2310}Available: \url{http://www.nature.com/articles/ng.2310}.
...
\hypertarget{apptRNAanno}{%
\section{Specific tRNA annotations used in the tRNA analyses}\label{apptRNAanno}}

\url{Supplementary_Files/SF5_hg19-tRNAs.bed}

\hypertarget{apptRNAprimers}{%
\section{tRNA targeted bisulfite sequencing primers}\label{apptRNAprimers}}

\url{Supplementary_Files/SF6_Targeted_BiS-seq_Primers.txt}

\hypertarget{apptRNAmods}{%
\section{Additional tRNA Age modelling results}\label{apptRNAmods}}
...
\url{Supplementary_Files/SF1_MeDIPseqtRNACombinedModelSummariesXL.xlsx}

\hypertarget{apptRNAmouse}{%
\section{tRNA mouse models}\label{apptRNAmouse}}

\url{Supplementary_Files/SF4_mouse_tRNA_age_models.xlsx}

\hypertarget{apptRNAprop}{%
\section{tRNA proportional enrichment fisher's test count data}\label{apptRNAprop}}

\url{Supplementary_Files/SF11_prop_enrich_fishers.xlsx}

\hypertarget{appTCGA}{%
\section{TCGA sample used in tRNA analysis}\label{appTCGA}}

\url{Supplementary_Files/SF7_TCGA_samples_used.tsv}

\hypertarget{apptwins450ktRNA}{%
\section{Twins UK 450k array tRNA age models}\label{apptwins450ktRNA}}

\url{Supplementary_Files/SF3_TwinsUK_450k_blood_tRNA_Age_Models.xlsx}

\hypertarget{appRXRACDKN2A}{%
\section{MAVIDOS RXRA and CDKN2A probe models}\label{appRXRACDKN2A}}

\url{Supplementary_Files/SF12_vitD_bone_meth_model_results.xlsx}

\hypertarget{appAluageSNPs}{%
\section{Age acceleration GWAS SNPs}\label{appAluageSNPs}}

model 1 \url{Supplementary_Files/SF8_suggestivem1full.tsv}

model 2 \url{Supplementary_Files/SF9_suggestivem2full.tsv}
