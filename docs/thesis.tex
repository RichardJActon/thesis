...
The 2 tRNAs located in chr1\_gl000192\_random are tRNA-Gly-CCC-8-1 \& tRNA-Asn-ATT-1-2 (\href{docs/Supplementary_Files/hg19-tRNAs.bed}{Supplementary File S1}).
...
Primer design was performed using `methPrimer' {[}\protect\hyperlink{ref-Li2002}{237}{]} (\href{docs/Supplementary_Files/Targeted_BiS-seq_Primers.txt}{Supplementary File S2}).
...
Selecting those probes overlapping tRNA genes yielded 73,403 data points across 19 tissues with an age range of 15-90yrs (median 63.4) (\href{docs/Supplementary_Files/TCGA_samples_used.tsv}{Supplementary File S3})
...
These three are tRNA-Asp-GTC-1-12, tRNA-Ile-AAT-1-4, tRNA-Glu-TTC-1-3 (Figure \ref{fig:mouse}). Full Age model Results are available in \href{docs/Supplementary_Files/SF4_mouse_tRNA_age_models.xlsx}{Supplementary File S4}.
...
These sites are listed in Supplementary Files \href{docs/Supplementary_Files/SF8_suggestivem1full.tsv}{S8} \& \href{docs/Supplementary_Files/SF9_suggestivem2full.tsv}{S9} with the top 10 sites from each GWAS shown in Figures \ref{fig:m1tab} \& \ref{fig:m2tab} respectively.
...
the pre-print is included as a \href{docs/Supplementary_Files/SF10_tRNApaper.pdf}{pdf file} with the supplementary data.
